...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Tambah Pendidikan</h5>
                ...
                <form action="{{ route('pendidikan.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body mt-3">
                        ...
                        <div class="form-group">
                            <label for="">Kebutuhan Laki-Laki</label>
                            <input type="number" class="form-control" required name="k_laki" placeholder=""
                                value="{{ old('k_laki') }}">
                        </div>
                        <div class="form-group">
                            <label for="">Kebutuhan Perempuan</label>
                            <input type="number" class="form-control" required name="k_perempuan" placeholder=""
                                value="{{ old('k_perempuan') }}">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Ubah Pendidikan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('pendidikan.update', 0) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body mt-3">
                        <div class="form-group">
                            <label for="">Nama</label>
                            <input type="text" class="form-control" required id="nama_edit" name="nama"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="">Kebutuhan Laki-Laki</label>
                            <input type="number" class="form-control" required id="k_laki_edit" name="k_laki"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="">Kebutuhan Perempuan</label>
                            <input type="number" class="form-control" required id="k_perempuan_edit" name="k_perempuan"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="">Keterangan</label>
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="margin-left:-25px;">
                        <div class="card-header-form">
                            <form method="get" action="{{ route('pendidikan.search') }}">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="width:5%;">
                                                <div style="display: flex; flex-direction: row;">
                                                    ...
                                                    <form action="{{ route('pendidikan.destroy', $dt->id) }}"
                                                        method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            onclick="return confirm('Yakin melanjutkan hapus data pengguna {{ $dt->pendidikan }} ?')"
    ...
    <script>
        function showEditModal(param) {
            var url = "{{ route('pendidikan.edit', ':id') }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#nama_edit').val(response.pendidikan);
                    $('#k_laki_edit').val(response.butuh_lk);
                    $('#k_perempuan_edit').val(response.butuh_pr);
        ...
        function downloadExcel() {
            ...
            var url = "{{ route('pendidikan.download') }}/?keyword=" + keyword;
