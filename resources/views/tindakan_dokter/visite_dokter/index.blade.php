...
@section('content')
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('visite_dokter.import') }}" method="POST" enctype='multipart/form-data'>
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Tambah Visite Dokter</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('visite_dokter.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body mt-3">
                        <div class="col-lg-12 row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Nama Visite</label>
                                    <input type="text" class="form-control" required name="nama_visite" id="nama_visite"
                                        placeholder="" value="{{ old('nama_visite') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="jasa_lain_lain"
                                        id="lain_lain" placeholder="" value="{{ old('lain_lain') }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="jasa_bhp" id="bhp"
                                        placeholder="" value="{{ old('bhp') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa Sewa Alat</label>
                                    <input type="number" class="form-control" name="jasa_sewa_alat"
                                        id="sewa_alat" placeholder="" value="{{ old('sewa_alat') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa Pelayanan</label>
                                    <input type="number" class="form-control" name="jasa_pelayanan"
                                        id="pelayanan" placeholder="" value="{{ old('pelayanan') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa Asisten</label>
                                    <input type="number" class="form-control" name="jasa_asisten"
                                        id="asisten" placeholder="" value="{{ old('asisten') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa Dokter</label>
                                    <input type="number" class="form-control" name="jasa_dokter"
                                        id="dokter" placeholder="" value="{{ old('dokter') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa RS</label>
                                    <input type="number" class="form-control" name="jasa_rs" id="rs"
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Ubah Visite Dokter</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('visite_dokter.update', 0) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-12 row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="nama_visite"
                                        id="nama_edit" placeholder="" value="{{ old('nama_visite') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Kelas</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Jasa BHP</label>
                                    <input type="number" class="form-control" name="jasa_bhp" id="bhp_edit"
                                        placeholder="" value="{{ old('bhp') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Jasa Sewa Alat</label>
                                ...
                                <div class="form-group">
                                    <label for="">Jasa RS</label>
                                    <input type="number" class="form-control" name="jasa_rs" id="rs_edit"
                                        placeholder="" value="{{ old('rs') }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card-header" style="margin-left: -25px;">
                            <div class="card-header-form">
                                <form method="get" action="{{ route('visite_dokter.search') }}">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn ml-2">
                                            ...
                                            <a class="btn btn-info"
                                                href="{{ asset('template/template_visite_dokter.csv') }}"
                                        ...
                                        <tr class="">
                                            ...
                                            <td style="width:5%;">
                                                <div style="display: flex; flex-direction: row;">
                                                    ...
                                                    <form action="{{ route('visite_dokter.destroy', $dt->id) }}"
                                                        method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
                                                            onclick="return confirm('Yakin melanjutkan hapus data {{ $dt->nama_visite }} ?')"
    ...
    <script>
        ...
        function showEditModal(param) {
            var url = "{{ route('visite_dokter.edit', ':id') }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#nama_edit').val(response.nama_visite);
        ...
        function downloadExcel() {
           ...
           var url = "{{ route('visite_dokter.download') }}";
