...
@section('content')
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('tindakan_dokter_inap.import') }}" method="POST" enctype='multipart/form-data'>
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Tambah Tindakan Dokter Inap</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('tindakan_dokter_inap.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="1" name="uri" id="uri" />
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: -15px;">
                    <h5 class="modal-title text-primary" id="exampleModalLongTitle">Ubah Tindakan Dokter Inap</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('tindakan_dokter_inap.update', 0) }}" method="post"
                    ...
                    <div class="modal-body mt-3">
                        <div class="col-lg-12 row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="">Lain-Lain</label>
                                    <input type="number" class="form-control" name="lain_lain" id="lain_lain_edit"
                                        placeholder="" value="{{ old('lain_lain') }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="">Sewa Alat</label>
                                    <input type="number" class="form-control" name="sewa_alat" id="sewa_alat_edit"
                                        placeholder="" value="{{ old('sewa_alat') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Asisten</label>
                                ...
                                <div class="form-group">
                                    <label for="">Dokter/Operator</label>
                                    <input type="number" class="form-control" name="operator" id="operator_edit"
                                        placeholder="" value="{{ old('operator') }}">
                                </div>
                                <div class="form-group">
                                    <label for="">RS</label>
                    ...
                    <div class="card-body">
                        <div class="card-header" style="margin-left: -25px;">
                            <div class="card-header-form">
                                <form method="get" action="{{ route('tindakan_dokter_inap.search') }}">
                                        ...
                                        <tr class="">
                                            ...
                                            <td style="width:5%;">
                                                <div style="display: flex; flex-direction: row;">
                                                    ...
                                                    <form action="{{ route('tindakan_dokter_inap.destroy', $dt->id) }}"
    ...
    <script>
        ...
        function showEditModal(param) {
            var url = "{{ route('tindakan_dokter_inap.edit', ':id') }}";
        ...
        function downloadExcel() {
            ...
            var url = "{{ route('tindakan_dokter_inap.download') }}";
