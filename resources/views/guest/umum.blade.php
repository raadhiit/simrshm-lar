    ...
    <div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('guest_registration/pasien_umum/create') }}" method="post">
                    @csrf
    ...
    <div class="row" style="margin-left: 0; width:100%; height:100vh;">
        ...
        <div class="col-lg-6" style="display: flex; justify-content: center; align-items: center;">
            <div id="box" class="card p-4" style="box-shadow: 3px 3px #999; width:100%;">
                ...
                <br>
                <h6 style="text-align: center;">Masukkan nomor rekam medis / NIK anda pada form dibawah ini.</h6>
                <br>
                <div class="row" style="width: 100%; margin-left: 0;">
                    <div class="col-lg-12 pl-0 pr-0">
                        <div class="input-group">
                            <input type="text" placeholder="No. Rekam Medis / No. KTP" class="form-control" id="identitas" required>
...
<script>
    ...
    $('#btn_search').click(function() {
        if ($('#identitas').val() == '') {
            alert('Masukkan nomor rekam medis / nik dahulu');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#btn_search').removeAttr('disabled');
                $('#box_btn_checkin').html('<a class="btn btn-warning" href="./pasien_umum/daftar?pasien=' + response.id + '" style="font-weight: bold; color:#fff;">Selanjutnya</a>');
            }
        })
    })
