    ...
    <div class="row" style="margin-left: 0; width:100%; height:100vh;">
        ...
        <div class="col-lg-6" style="display: flex; justify-content: center; align-items: center;">
            <div id="box" class="card p-4" style="box-shadow: 3px 3px #999; width:100%;">
                ...
                <br>
                <h6 style="text-align: center;">Pendaftaran Pasien BPJS.</h6>
                <br>
                ...
                <div class="row" style="width: 100%; margin-left: 0;">
                    <form class="col-lg-12 pl-0 pr-0" method="post" action="{{ url('guest_registration/pasien_bpjs/daftar/post') }}">
                        @csrf
                        <input type="hidden" name="pasien" value="{{$pasien->id}}">
                        <div class="form-group">
                            <label for="">No. BPJS</label>
                            <input type="number" min="0" required name="nobpjs" value="{{$pasien->nobpjs}}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">No. Referensi</label>
                            <input type="text" required name="nomorreferensi" class="form-control">
                        </div>
                        <div class="form-group">
