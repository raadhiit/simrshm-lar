...
<body>
    ...
    <div class="row" style="width:96.7%; margin-left: 0px">
        <div class="half_column text-left" style="padding: 10px; height:85px;">
        ...
        <div class="half_column" style="height: 105px; border: 1px solid; border-radius:10px;">
            <table id="tabel_kop_identitas" style="font-size: 12px; margin-top: 20px; line-height: 1em">
                ...
                <tr>
                    <td style="padding-left: 10px;">No. RM</td>
                    <td class="pl-2 pr-2"> :</td>
                    <td>{{ $pasien->id }}</td>
                </tr>
                <tr>
    ...
    <div class="row">
        <div
        style="float: left; width: 95.8%; margin-left: 15px; margin-top: px;"
        class="text-center">
        <br>
        <b style="text-align: center; justify-items: center; color: black; font-size: 13px;">SURAT KONTROL</b>
    </div>
</div>
<div class="row">
    <div class="row" style="width: 96%; margin-left: 15px; margin-top: -2px;">
        <div class="col-md-12">    
            <table style="border-collapse: collapse; width:100%; font-size: 14px;" class="mb-3">
                <tr class="align-top">
                ...
                <tr class="align-top">
                    <td style="width: 20%;">Tgl Surat Rujukan</td>
                    <td style="width: 3%;"> : </td>
                    <td style="width: 78%;">
