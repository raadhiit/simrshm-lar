...
<script>
    ...
    function render_pesanan_lab(deta) {
        ...
        var ins = '<div style="display: flex; flex-direction: row">' +
            '<div style="width:30%">' +
            '<button type="button" data-toggle="tooltip" title="Ubah Pemeriksaan" class="btn btn-warning" onclick="open_modal_lab(' + "'" + (deta.lab ? deta.lab.id : 0) + "','" + deta.id + "'" + ')"><i class="fa fa-pencil" style="color:#fff;"></i></button>' +
            ...
            '<button type="button" data-toggle="tooltip" title="Hapus" class="btn btn-danger ml-1" data-toggle="tooltip" title="Hapus" onclick="hapus_pesanan_lab(' + "'" + (deta.lab ? deta.lab.id : 0) + "','" + deta.id + "'" + ')"><i class="fa fa-trash" style="color:#fff;"></i></button>' +
            '</div>' +
    ...
    function render_pesanan_rad(deta) {
        ...
        var ins = '<div style="display: flex; flex-direction: row">' +
            '<div style="width:30%">' +
            '<button type="button" data-toggle="tooltip" title="Ubah Pemeriksaan" class="btn btn-warning" onclick="open_modal_rad(' + "'" + deta.rad.id + "','" + deta.id + "'" + ')"><i class="fa fa-pencil" style="color:#fff;"></i></button>' +
            ...
            '<button type="button" data-toggle="tooltip" title="Hapus" class="btn btn-danger ml-1" data-toggle="tooltip" title="Hapus" onclick="hapus_pesanan_rad(' + "'" + deta.rad.id + "','" + deta.id + "'" + ')"><i class="fa fa-trash" style="color:#fff;"></i></button>' +
            '</div>' +
            '<div class="pl-3 pt-1" style="width:70%">' +
