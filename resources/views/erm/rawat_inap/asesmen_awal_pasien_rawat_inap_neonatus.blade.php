...
<body class="p-2">
    <form action="" id="form_neonatus" class="container-fluid">
        <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
        <input type="hidden" name="list_riwayat_imunisasi">
        <input type="hidden" name="pass">
        <input type="hidden" name="tipe_verif" id="tipe_verif">
        ...
        <div class="row p-2">
            ...
            <div class="col-md-12 pb-2 pt-1" style="border:1px solid #111; border-top:1px solid transparent;">
                ...
                <textarea name="tindakan_perawat" cols="30" rows="5" class="form-control">{{ $neonatus ? $neonatus->tindakan_perawat : '' }}</textarea>
                <br>
                <div>
                ...
                <table style="width:100%; border-collapse: collapse" border="1" class="mt-2">
                    ...
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td style="width:50%;" id="box_ttd_dokter" onclick="open_modal_ttd_dokter('dokter')">
                                Dokter
                                <br>
                                @if ($dokumen->status == 1)
            ...
            <div class="col-md-12 pb-2 pt-1" style="border:1px solid #111; border-top:1px solid transparent;">
                ...
                <table class="tabel_layout">
                    ...
                    <tr>
                        ...
                        <td style="width:3%"> : </td>
                        <td colspan="2">
                            <input type="radio" name="pernah_dirawat" {{ $neonatus ? $neonatus->pernah_dirawat == 'Ya' ? 'checked' : '' : 'checked' }} value="Ya"> Ya / 
                            <input type="radio" name="pernah_dirawat" {{ $neonatus ? $neonatus->pernah_dirawat == 'Tidak' ? 'checked' : '' : 'checked' }} value="Tidak"> Tidak
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 15%">
                                                    <input type="radio" name="sistem_reproduksi_l"
                                                         value="Normal" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Normal' ? 'checked' : '' : '' }}> Normal
                                                </td>
                                                <td style="width: 20%">
                                                    <input type="radio" name="sistem_reproduksi_l"
                                                         value="Hipospadia" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Hipospadia' ? 'checked' : '' : '' }}> Hipospadia
                                                </td>
                                                <td style="width: 24%">
                                                    <input type="radio" name="sistem_reproduksi_l"
                                                         value="Epispadia" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Epispadia' ? 'checked' : '' : '' }}> Epispadia
                                                </td>
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_l"
                                                         value="Fimois" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Fimois' ? 'checked' : '' : '' }}> Fimois
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_l"
                                                         value="Hidrokel" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Hidrokel' ? 'checked' : '' : '' }}> Hidrokel
                                                </td>
                                                <td colspan="3">
                                                    <input type="radio" {{ $pasien->kelamin != 0 ? 'disabled' : '' }} name="sistem_reproduksi_l" {{ $neonatus ? $neonatus->sistem_reproduksi_l == 'Lain' ? 'checked' : '' : '' }}
                                                        value="Lain" > <input type="text"
                                                        name="sistem_reproduksi_l_lain" {{ $pasien->kelamin != 0 ? 'readonly' : '' }} value="{{ $neonatus ? $neonatus->sistem_reproduksi_l_lain : '' }}"
                                                        style="width: 80%; border-radius:5px; border:1px solid lightgrey;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_p"
                                                         value="Normal" {{ $pasien->kelamin != 1 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_p == 'Normal' ? 'checked' : '' : '' }}> Normal
                                                </td>
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_p"
                                                         value="Keputihan" {{ $pasien->kelamin != 1 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_p == 'Keputihan' ? 'checked' : '' : '' }}> Keputihan
                                                </td>
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_p"
                                                         value="Vagina Skintag" {{ $pasien->kelamin != 1 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_p == 'Vagina Skintag' ? 'checked' : '' : '' }}> Vagina Skintag
                                                </td>
                                                <td>
                                                    <input type="radio" name="sistem_reproduksi_p"
                                                         value="Lain" {{ $pasien->kelamin != 1 ? 'disabled' : '' }} {{ $neonatus ? $neonatus->sistem_reproduksi_p == 'Lain' ? 'checked' : '' : '' }}> <input type="text"
                                                        name="sistem_reproduksi_p_lain" {{ $pasien->kelamin != 1 ? 'readonly' : '' }} value="{{ $neonatus ? $neonatus->sistem_reproduksi_p_lain : '' }}"
                                                        style="width: 80%; border-radius:5px; border:1px solid lightgrey;">
                                                </td>
                                            </tr>
                                        </table>
            ...
            <div class="col-md-12 pb-2 pt-1" style="border:1px solid #111; border-top:1px solid transparent;">
                ...
                <p style="text-align: center" onclick="open_modal_ttd_dokter('perawat')">
                    Bekasi, {{ date('d/m/Y', strtotime($dokumen->created_at)) }}, Jam {{ date('H:i', strtotime($dokumen->created_at)) }}<br>
                    Perawat<br>
                    <span id="box_ttd_perawat">
                        @if($neonatus)
                            @if ($neonatus->id_perawat_verif != 0)
                                <img src="{{ env('SMIS_UPLOAD_URL') . '/' . ($perawat ? $perawat->ttd : '') }}" style="width: 5cm; height:3cm;" alt="">
                                <br>
                                {{ $neonatus->nama_perawat_verif }}
                            @else
                                <br>
                                <br>
                                <br>
...
<script>
    ...
    function open_modal_ttd_dokter(param){
        $('#tipe_verif').val(param);
    ...
    function update_neonatus() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status) {
                    if (response.dokumen.status == 1) {
                        $('#box_ttd_dokter').html(`Dokter<br><img src="{{ env('SMIS_UPLOAD_URL') }}/`+response.employee.ttd+`" style="height: 2cm; width: 3cm;" alt="">`+
                        `<br>`+response.dokumen.nama_verifikator)
                    }

                    if (response.neonatus.id_verifikator_verif != 0) {
                        $('#box_ttd_perawat').html(`<img src="{{ env('SMIS_UPLOAD_URL') }}/`+response.perawat.ttd+`" style="height: 3cm; width: 5cm;" alt="">`+
                        `<br>`+response.neonatus.nama_perawat_verif)
                    }
                }
            }
        })
    ...
    function set_riwayat_imunisasi(row,column,value){
        ...
        console.log(koor_x_imunisasi+','+koor_y_imunisasi);
    ...
    function open_form_resep() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#resep_dokter').val(null_resep ? response.nama_dokter : '{{ Auth::user()->realname }}');
                $('#resep_id_dokter').val(null_resep ? response.id_dokter : '{{ Auth::user()->id }}');
                $('#resep_sip').val(null_resep ? response.sip_dokter : '{{Session::get("sip")}}');
