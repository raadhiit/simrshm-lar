        ...
        <script>
            ...
            $('#filter').submit(function(e) {
                ...
                $('#tabel_pasien').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '../ajax_request/filter_erm_ranap?'+$('#filter').serialize(),
                    columns: [{
                            data: null,
                            name:null,
                            orderable: false,
                        ...
                        },
                        {
                            ...
                            searchable: false,
                            render: function(data, type, row, meta) {
                                return '<div class="text-center"><a href="./rawat_inap/detail?nrm='+row.nrm+'" class="btn btn-success"><i class="fa fa-edit"></i></a></div>';
                            }
                        },
                    ]
                });
