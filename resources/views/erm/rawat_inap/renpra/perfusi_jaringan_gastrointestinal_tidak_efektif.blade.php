<form id="form-{{ Illuminate\Support\Str::slug($renpra->id.' '.$renpra->nama_renpra, '-') }}" class="form-renpra w-100" method="post" autocomplete="off">
    ...
    <table class="w-100 table-renpra mt-1">
        ...
        <tr class="align-top">
            ...
            <td class="p-1">
                <p><strong>Perfusi jaringan gastrointestinal tidak efektif</strong> b/d gangguan afinitas Hb oksigen, penurunan konsentrasi Hb, Hipervolemia, Hipoventilasi, gangguan transport O2, gangguan aliran arteri dan vena.</p>
                <p>DS:</p>
    ...
    <div class="w-100 text-right mb-2">RSHM/RI/57.01/Rev.00</div>
</form>