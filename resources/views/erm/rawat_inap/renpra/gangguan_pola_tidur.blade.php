<form id="form-{{ Illuminate\Support\Str::slug($renpra->nama_renpra, '-') }}" class="form-renpra w-100" method="post" autocomplete="off">
    ...
    <table class="w-100 table-renpra mt-1">
        ...
        <tr class="align-top">
            ...
            <td class="p-1">
                <p><strong>Gangguan pola tidur</strong> berhubungan dengan :</p>
                <p></p>
                ...
                <p>Fisiologis : Demam, mual, posisi, urgensi urin.</p>
                <p>DS :</p>
                <ul class="list-unstyled">
                    @foreach([
            ...
            <td class="p-1">
                ...
                <p>Gangguan pola tidur pasien teratasi dengan kriteria hasil:</p>
                <ul class="list-unstyled">
                    @foreach(
                    [
