<form id="form-{{ Illuminate\Support\Str::slug($renpra->nama_renpra, '-') }}" class="form-renpra w-100" method="post"
    ...
    <table class="w-100 table-renpra mt-1">
        ...
        <tr class="align-top">
            ...
            <td class="p-1">
                <p><strong>Hipotermia,</strong> </br> Suatu tubuh berada di bawah kisaran normal Berhubungan dengan :
                </p>
                <ul class="list-unstyled">
                    @foreach([
                    'Malnutrisi',
                    'Pemakian pakaian yang tidak adequate',
                    'Hipotalamus',
                    ] as $index => $item)
                    <li>
                ...
                <ul class="list-unstyled">
                    @foreach([
                    'Penurunan suhu tubuh diatas rentang normal',
            ...
            <td class="p-1">
                <ul class="list-unstyled">
                    ...
                    'Ajarkan pada pasien secara mencegah keletihan akibat panas',
                    'Diskusikan tentang pentingnya pentingnya pengaturan suhu dan kemungkinan efek negative dan
                    kedinginan',
