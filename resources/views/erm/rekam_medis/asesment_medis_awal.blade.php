...
<body style="margin: 20px;">
    ...
    <form onsubmit="return cek_form_ttd(this)" id="form_persetujuan"
        action="{{ url('e_rekam_medis/rekam_medis/save_asesment_medis_awal_rawat_jalan') }}" method="post">
        @csrf
        <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
...
@if (old('status_generalis')){{ old('status_generalis') }}@else{{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->status_generalis : '' }}@endif
    ...
    <div class="row pb-5 pt-5" style="width:100%; margin-left:0;">
        <div style="text-align: center;" class="col-md-12">
            @if ($dokumen->id_verifikator != 0)
                <a href="{{ url('e_rekam_medis/rekam_medis/pdf_asesment_medis_awal_rawat_jalan?dokumen=' . $dokumen->id) }}"
                        ...
                        <div class="row pt-3" style="width: 100%; margin-left: 0;">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="e_resep_kode_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="e_resep_jenis_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Sisa</label>
                                    <input type="text" id="e_resep_sisa_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Satuan</label>
                                    <input type="text" id="e_resep_satuan_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="e_resep_harga_obat"  class="form-control">
                    ...
                    <div class="modal-body">
                        <div class="row" style="width: 100%; margin-left: 0;">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">SIP</label>
                                    <input class="form-control" name="sip" id="edit_resep_sip" value="{{ Session::has('sip') ? Session::get('sip') : '' }}"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat</label>
                        ...
                        <div class="row pt-3" style="width: 100%; margin-left: 0;">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Kode</label>
                                    <input type="text" id="edit_resep_kode_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Obat</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label for="">Jenis</label>
                                    <input type="text" id="edit_resep_jenis_obat" 
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Sisa</label>
                                    <input type="text" id="edit_resep_sisa_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Satuan</label>
                                    <input type="text" id="edit_resep_satuan_obat" 
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Jumlah</label>
                                ...
                                <div class="form-group">
                                    <label for="">Harga (Rp.)</label>
                                    <input type="text" id="edit_resep_harga_obat" 
                                        class="form-control">
