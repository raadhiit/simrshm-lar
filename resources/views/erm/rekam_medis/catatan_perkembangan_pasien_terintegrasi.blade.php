            ...
            <table style="width: 100%;" class="table_isian_bordered">
                ...
                <td style="vertical-align: text-top">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" readonly
                               value="{{ $dokumen->catatan_perkembangan_pasien_terintegrasi ? $dokumen->catatan_perkembangan_pasien_terintegrasi->ppa : ''}}"
                ...
                <td colspan="2">
                    ...
                    <textarea id="subyektif" class="form-control"
                              rows="5">@if (old('subyektif')){{ old('subyektif') }}@else{{ $dokumen->catatan_perkembangan_pasien_terintegrasi ? $dokumen->catatan_perkembangan_pasien_terintegrasi->subyektif : '' }}@endif</textarea>
                    <br>
                    <br>
                    OBYEKTIF
                    <br>
                    ...
                    <br>
                    Diagnosa Sekunder :
                    <div style="display: flex; flex-direction: row" id="box_diagnosa_sekunderz">
                        <?php
                        if ($layanan->diagnosa != null) {
                            $temp = '';
                ...
                <td style="width: 20%; vertical-align: text-top">
                    ...
                    <textarea id="instruksi_kesehatan" class="form-control"
                              rows="5">@if (old('instruksi_kesehatan')){{ old('instruksi_kesehatan') }}@else{{ $dokumen->catatan_perkembangan_pasien_terintegrasi ? $dokumen->catatan_perkembangan_pasien_terintegrasi->instruksi_kesehatan : '' }}@endif</textarea>
                </td>
                <td style="vertical-align: text-top; text-align: center">
                    &nbsp;
                    <br>
