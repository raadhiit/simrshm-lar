...
<form onsubmit="return cek_form(this)" id="form_persetujuan"
      action="{{ url('e_rekam_medis/rekam_medis/save_dokumen_asesment_awal_keperawatan_igd') }}" method="post">
    @csrf
    <input type="hidden" name="dokumen" value="{{$dokumen->id}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                                ...
                                @endif
                                type="radio" value="ambulance" name="radio_transportasi"> Ambulance, 
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                                ...
                                @endif
                                type="radio" value="kendaraan_pribadi" name="radio_transportasi" class="ml-4"> Kendaraan Pribadi, 
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                                ...
                                @endif
                                type="radio" value="datang_sendiri" name="radio_transportasi" class="ml-4"> Datang Sendiri,
                        </div>
                    </div>
                </td>
            </tr>
                        ...
                        <div class="col-md-10">
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                               {{ old('transportasi') ==  'rujukan' ? 'checked' : '' }}
                                ...
                                @endif
                                type="radio" value="rujukan" name="radio_transportasi"> Rujukan, dari 
                            <input type="text" readonly
                            ...
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                               {{ old('transportasi') ==  'auto_anamnesa' ? 'checked' : '' }}
                                ...
                                @endif
                                type="radio" value="auto_anamnesa" name="radio_transportasi"> Auto Anamnesa
                            <input onclick="cek_radio_transportasi()" @if(old('transportasi'))
                               {{ old('transportasi') ==  'allo_anamnesa' ? 'checked' : '' }}
                                ...
                                @endif
                                type="radio" value="allo_anamnesa" name="radio_transportasi" class="ml-4"> Allo Anamnesa 
                            <input type="text" readonly
            ...
            <tr>
                    ...
                    @if ($dokumen->dokumen_asesment_awal_keperawatan_igd)
                        @if ($dokumen->dokumen_asesment_awal_keperawatan_igd->gambar_status_lokalis != '')
                            <a style="position:relative; top:0px;"
                                ...
                                class="btn btn-dark"
                                href="{{ url('e_rekam_medis/rekam_medis/hapus_gambar_lokalis?dokumen=' . $dokumen->id.'&jenis_dokumen=dokumen_asesment_awal_keperawatan_igd') }}">Gambar
                                ulang</a>
                        @else
                ...
                <td style="padding-left: 10px; width: 40%" rowspan="3">
                    ...
                    <input @if(old('tanda_kehidupan'))
                        ...
                        @endif
                        type="radio" value="doa" name="radio_tanda_kehidupan"> Death On Arrival
                    <br>
                    <input @if(old('tanda_kehidupan'))
                        ...
                        @endif
                        type="radio" value="denyut_nadi" name="radio_tanda_kehidupan"> Denyut Nadi (-)
                    <br>
                    <input @if(old('tanda_kehidupan'))
                        ...
                        @endif
                        type="radio" value="reflek_cahaya" name="radio_tanda_kehidupan"> Reflek Cahaya (-)
                    <br>
                    <input @if(old('tanda_kehidupan'))
                        ...
                        @endif
                        type="radio" value="ekg_asystole" name="radio_tanda_kehidupan"> EKG Asystole
                    <br>
            ...
            <tr>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                        ...
                        @endif
                        type="radio" value="dokter" name="radio_pemeriksaan_antenatal"> Dokter
                </td>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                            {{ old('pemeriksaan_antenatal') ==  'bidan' ? 'checked' : '' }}
                        @else
                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->pemeriksaan_antenatal == 'bidan' ? 'checked' : '') : '' }}
                        @endif
                        type="radio" value="bidan" name="radio_pemeriksaan_antenatal"> Bidan
                </td>
                <td colspan="2"></td>
            </tr>
            <tr>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                        ...
                        @endif
                        type="radio" value="terdaftar" name="radio_pemeriksaan_antenatal"> Terdaftar
                </td>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                        ...
                        @endif
                        type="radio" value="tidak_terdaftar" name="radio_pemeriksaan_antenatal"> Tidak Terdaftar
                </td>
                <td colspan="2"></td>
            </tr>
            <tr>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                        ...
                        @endif
                        type="radio" value="tidak_teratur" name="radio_pemeriksaan_antenatal"> Tidak Teratur
                </td>
                <td>
                    <input onclick="cek_radio_pemeriksaan_antenatal()" @if(old('pemeriksaan_antenatal'))
                        ...
                        @endif
                        type="radio" value="teratur" name="radio_pemeriksaan_antenatal"> Teratur : 
                    <input type="text" readonly
                ...
                <td colspan="4">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            @endif
                            type="radio" value="suntik" name="radio_riwayat_kb"> Suntik 
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_kb()" @if(old('riwayat_kb'))
                            ...
                            @endif
                            type="radio" value="pil" name="radio_riwayat_kb"> Pil 
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_kb()" @if(old('riwayat_kb'))
                            ...
                            @endif
                            type="radio" value="implan" name="radio_riwayat_kb"> Implan
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_kb()" @if(old('riwayat_kb'))
                            ...
                            @endif
                            type="radio" value="mow" name="radio_riwayat_kb"> MOW
                        </div>
                        <div class="col-md-4">
                            <input onclick="cek_radio_riwayat_kb()" @if(old('riwayat_kb'))
                                ...
                                @endif
                                type="radio" value="lain_lain" name="radio_riwayat_kb">
                            <input type="text" readonly
                ...
                <td colspan="4">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            @endif
                            type="radio" value="infertilitas" name="radio_riwayat_ginekologi"> Infertilitas 
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_ginekologi()" @if(old('riwayat_ginekologi'))
                            ...
                            @endif
                            type="radio" value="anemia" name="radio_riwayat_ginekologi"> Anemia 
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_ginekologi()" @if(old('riwayat_ginekologi'))
                            ...
                            @endif
                            type="radio" value="infeksi_virus" name="radio_riwayat_ginekologi"> Infeksi Virus
                        </div>
                        <div class="col-md-2">
                            <input onclick="cek_radio_riwayat_ginekologi()" @if(old('riwayat_ginekologi'))
                                {{ old('riwayat_ginekologi') ==  'pms' ? 'checked' : '' }}
                            @else
                                {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->riwayat_ginekologi == 'pms' ? 'checked' : '') : '' }}
                            @endif
                            type="radio" value="pms" name="radio_riwayat_ginekologi"> PMS
                        </div>
                        <div class="col-md-4">
                            <input onclick="cek_radio_riwayat_ginekologi()" @if(old('riwayat_ginekologi'))
                                ...
                                @endif
                                type="radio" value="lain_lain" name="radio_riwayat_ginekologi">
                            <input type="text" readonly
            ...
            <tr>
                <td colspan="4">
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="terdaftar" name="radio_riwayat_penyakit_kehamilan"> Terdaftar 
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="anemia" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> Anemia  
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="vitium_cordis" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> Vitium Cordis
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="diabetes" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> Diabetes
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="hipertensi" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> Hipertensi
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="tbc" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> TBC
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="hepatitis" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> Hepatitis
                    <input @if(old('riwayat_penyakit_kehamilan'))
                            ...
                            @endif
                            type="radio" value="aca" name="radio_riwayat_penyakit_kehamilan" class="ml-4"> ACA
                </td>
            </tr>
            <tr>
                <td colspan="4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input onclick="cek_radio_komplikasi_kehamilan()" @if(old('komplikasi_kehamilan'))
                                        ...
                                        @endif
                                        type="radio" value="tidak" name="radio_komplikasi_kehamilan"> Tidak
                                </div>
                                <div class="col-md-6">
                                    <input onclick="cek_radio_komplikasi_kehamilan()" @if(old('komplikasi_kehamilan'))
                                        ...
                                        @endif
                                        type="radio" value="ada" name="radio_komplikasi_kehamilan"> Ada :
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-2">
                                    <input onclick="cek_radio_det_komplikasi_kehamilan()" @if(old('det_komplikasi_kehamilan'))
                                            {{ old('det_komplikasi_kehamilan') ==  'hav' ? 'checked' : '' }}
                                        @else
                                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->det_komplikasi_kehamilan == 'hav' ? 'checked' : '') : '' }}
                                        @endif
                                        type="radio" value="hav" class="radio_det_komplikasi_kehamilan" name="radio_det_komplikasi_kehamilan" disabled> HAV
                                </div>
                                <div class="col-md-2">
                                    <input onclick="cek_radio_det_komplikasi_kehamilan()" @if(old('det_komplikasi_kehamilan'))
                                            {{ old('det_komplikasi_kehamilan') ==  'hpp' ? 'checked' : '' }}
                                        @else
                                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->det_komplikasi_kehamilan == 'hpp' ? 'checked' : '') : '' }}
                                        @endif
                                        type="radio" value="hpp" class="radio_det_komplikasi_kehamilan" name="radio_det_komplikasi_kehamilan" disabled> HPP
                                </div>
                                <div class="col-md-3">
                                    <input onclick="cek_radio_det_komplikasi_kehamilan()" @if(old('det_komplikasi_kehamilan'))
                                            {{ old('det_komplikasi_kehamilan') ==  'peb' ? 'checked' : '' }}
                                        @else
                                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->det_komplikasi_kehamilan == 'peb' ? 'checked' : '') : '' }}
                                        @endif
                                        type="radio" value="peb" class="radio_det_komplikasi_kehamilan" name="radio_det_komplikasi_kehamilan" disabled> PEB/PER/Eklamasi
                                </div>
                                <div class="col-md-5">
                                    <input onclick="cek_radio_det_komplikasi_kehamilan()" @if(old('det_komplikasi_kehamilan'))
                                            {{ old('det_komplikasi_kehamilan') ==  'lain_lain' ? 'checked' : '' }}
                                        @else
                                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->det_komplikasi_kehamilan == 'lain_lain' ? 'checked' : '') : '' }}
                                        @endif
                                        type="radio" value="lain_lain" class="radio_det_komplikasi_kehamilan" name="radio_det_komplikasi_kehamilan" disabled>
                                    <input type="text" readonly
                                        ...
                                        @if(old('det_komplikasi_kehamilan'))
                                            {{ old('det_komplikasi_kehamilan') ==  'lain_lain' ? '' : 'readonly' }}
                                        @else
                                            {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->det_komplikasi_kehamilan == 'lain_lain' ? '' : 'readonly') : 'readonly' }}
                                        @endif>
                                </div>
                            </div>
                        </div>
            ...
            <tr>
                <td colspan="4">
                    <input @if(old('riwayat_imunisasi'))
                            ...
                            @endif
                            type="radio" value="tidak" name="radio_riwayat_imunisasi"> Tidak 
                    <input @if(old('riwayat_imunisasi'))
                            ...
                            @endif
                            type="radio" value="ya" name="radio_riwayat_imunisasi" class="ml-4"> Ya
                    <input @if(old('riwayat_imunisasi'))
                            ...
                            @endif
                            type="radio" value="tt1" name="radio_riwayat_imunisasi" class="ml-4"> TT1
                    <input @if(old('riwayat_imunisasi'))
                            ...
                            @endif
                            type="radio" value="tt2" name="radio_riwayat_imunisasi" class="ml-4"> TT2
                    <input @if(old('riwayat_imunisasi'))
                            ...
                            @endif
                            type="radio" value="tt3" name="radio_riwayat_imunisasi" class="ml-4"> TT3
                </td>
            </tr>
            <tr>
                <td colspan="4">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    @endif
                                    type="radio" value="kep" name="radio_persentase_kebidanan"> Kep
                                </div>
                                <div class="col-md-5">
                                    <input onclick="cek_radio_persentase_kebidanan()" @if(old('persentase_kebidanan'))
                                    ...
                                    @endif
                                    type="radio" value="bokong" name="radio_persentase_kebidanan"> Bokong
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    type="radio" value="penurunan" name="radio_persentase_kebidanan"> Penurunan
                                    <input type="text" readonly
                                    ...
                                    @if(old('persentase_kebidanan'))
                                        {{ old('persentase_kebidanan') ==  'penurunan' ? '' : 'readonly' }}
                                    @else
                                        {{ $dokumen->dokumen_asesment_awal_keperawatan_igd ? ($dokumen->dokumen_asesment_awal_keperawatan_igd->persentase_kebidanan == 'penurunan' ? '' : 'readonly') : 'readonly' }}
                                    @endif>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <input onclick="cek_radio_keluar()" @if(old('keluar'))
                                ...
                                @endif
                                type="radio" value="darah" name="radio_keluar"> Darah
                            <span style="float: right">:</span>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <input onclick="cek_radio_keluar()" @if(old('keluar'))
                                ...
                                @endif
                                type="radio" value="air_ketuban" name="radio_keluar"> Air Ketuban
                            <span style="float: right">:</span>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <input onclick="cek_radio_keluar()" @if(old('keluar'))
                                ...
                                @endif
                                type="radio" value="lendir" name="radio_keluar"> Lendir
                            <span style="float: right">:</span>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <input onclick="cek_radio_keluar()" @if(old('keluar'))
                                ...
                                @endif
                                type="radio" value="dislokasi" name="radio_keluar"> Dislokasi
                            <span style="float: right">:</span>
                        </div>
                        <div class="col-md-4">
        ...
        <table style="width: 100%; border-top: hidden" class="table_isian">
            <tr style="border: 1px solid">
                <td colspan="4" style="text-align: center">
                    ...
                    <br>
                    <span style="font-size: 10px">(diisi pada pasien Anak/Pediatrik/Neonatus)</span>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding-left: 30px">
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="dm" name="radio_penyakit_ibu"> DM
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="hipertensi" name="radio_penyakit_ibu" class="ml-4"> Hipertensi
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="jantung" name="radio_penyakit_ibu" class="ml-4"> Jantung
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="tbc" name="radio_penyakit_ibu" class="ml-4"> TBC
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="hepb" name="radio_penyakit_ibu" class="ml-4"> Hep B
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="asma" name="radio_penyakit_ibu" class="ml-4"> Asma
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
                                ...
                                @endif
                                type="radio" value="alergi" name="radio_penyakit_ibu" class="ml-4"> Alergi
                            <input onclick="cek_radio_penyakit_ibu()" @if(old('penyakit_ibu'))
            ...
            <tr>
                <td colspan="4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="riwayat_diagnosa_ibu" readonly style="border: hidden; border-bottom: 1px dotted; width: 100%"
                ...
                <td colspan="4">
                    ...
                    <div class="row" style="padding-left: 20px">
                        <div class="col-md-2">
                            <input @if(old('resiko_infeksi'))
                                ...
                                @endif
                                type="radio" value="ada" name="radio_resiko_infeksi"> Ada
                        </div>
                        <div class="col-md-2">
                            <input @if(old('resiko_infeksi'))
                                ...
                                @endif
                                type="radio" value="tidak_ada" name="radio_resiko_infeksi"> Tidak Ada
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-1">
                    ...
                    <div class="row" style="padding-left: 20px">
                        <div class="col-md-3">
                            <input @if(old('mayor'))
                                ...
                                @endif
                                type="radio" value="ibu_demam" name="radio_mayor"> Ibu Demam Lebih Dari 38<sup>o</sup>C
                        </div>
                        <div class="col-md-3">
                            <input @if(old('mayor'))
                                ...
                                @endif
                                type="radio" value="kpd" name="radio_mayor"> KPD > 24 Jam
                        </div>
                        <div class="col-md-3">
                            <input @if(old('mayor'))
                                ...
                                @endif
                                type="radio" value="ketuban_hijau" name="radio_mayor"> Ketuban Hijau
                        </div>
                        <div class="col-md-3">
                            <input @if(old('mayor'))
                                ...
                                @endif
                                type="radio" value="vetal_distress" name="radio_mayor"> Vetal Distress
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-1">
                    ...
                    <div class="row" style="padding-left: 20px">
                        <div class="col-md-2">
                            ...
                            @endif
                            type="radio" value="kpd" name="radio_minor"> KPD > 12 Jam
                        </div>
                        <div class="col-md-2">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="aspixia" name="radio_minor"> Aspixia
                        </div>
                        <div class="col-md-2">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="bblr" name="radio_minor"> BBLR
                        </div>
                        <div class="col-md-2">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="isk" name="radio_minor"> ISK
                        </div>
                        <div class="col-md-2">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="uk" name="radio_minor"> UK > 37 Jam
                        </div>
                        <div class="col-md-2">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="gemeli" name="radio_minor"> Gemeli
                        </div>
                    </div>
                    <div class="row" style="padding-left: 20px">
                        <div class="col-md-2">
                            ...
                            @endif
                            type="radio" value="keputihan" name="radio_minor"> Keputihan
                        </div>
                        <div class="col-md-4">
                            <input @if(old('minor'))
                            ...
                            @endif
                            type="radio" value="ibu_demam" name="radio_minor"> Ibu Temperatur Lebih dari 37<sup>o</sup>C
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            BB : <input type="number" id="bb" readonly style="border: hidden; border-bottom: 1px dotted;"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="number" onkeydown="hitung_imt()"
                                   ...
                                   id="bb_gizi" min="0" step="0.01" style="border: 0; border-bottom: 2px dotted;"> Kg
                        </div>
                        <div class="col-md-4">
                            PB/TB :
                            <input type="number" onkeydown="hitung_imt()"
                                   ...
                                   id="pb_gizi" min="0" step="0.01" style="border: 0; border-bottom: 2px dotted;"> cm
                        </div>
                        <div class="col-md-4">
                            IMT :
                            <input type="number"
...
<div class="row pb-5 pt-5" style="width:100%; margin-left:0;">
    <div style="text-align: center;" class="col-md-12">
        @if($dokumen->id_verifikator != 0)
            <a href="{{ url('e_rekam_medis/rekam_medis/pdf_dokumen_asesment_awal_keperawatan_igd?dokumen='.$dokumen->id) }}"
...
<script>
    ...
    function cek_form() {
        ...
        $('#hide_riwayat_kb').val($('[name="radio_riwayat_kb"]:checked').val());
        ...
        $('#hide_riwayat_penyakit_kehamilan').val($('[name="radio_riwayat_penyakit_kehamilan"]:checked').val());
        ...
        $('#hide_komplikasi_kehamilan').val($('[name="radio_komplikasi_kehamilan"]:checked').val());
        $('#hide_det_komplikasi_kehamilan').val($('[name="radio_det_komplikasi_kehamilan"]:checked').val());
        $('#hide_ket_det_komplikasi_kehamilan').val($("#ket_det_komplikasi_kehamilan").val());
        $('#hide_riwayat_imunisasi').val($('[name="radio_riwayat_imunisasi"]:checked').val());
        ...
        $('#hide_resiko_infeksi').val($('[name="radio_resiko_infeksi"]:checked').val());
        $('#hide_mayor').val($('[name="radio_mayor"]:checked').val());
        $('#hide_minor').val($('[name="radio_minor"]:checked').val());
    ...
    function cek_radio_riwayat_kb() {
        if ($('[name="radio_riwayat_kb"]:checked').val() == 'lain_lain') {
    ...
    function cek_radio_det_komplikasi_kehamilan() {
        if ($('[name="radio_det_komplikasi_kehamilan"]:checked').val() == 'lain_lain') {
