...
<body class="pt-2 pb-2">
                ...
                <form action="#" id="form_riwayat_kehamilan" onsubmit="return add_riwayat_kehamilan()">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" id="tahun_partus" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Tempat Partus</label>
                            <input type="tetxt" id="tempat_partus" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Umur Hamil</label>
                            <input type="text" id="umur_hamil" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Jenis Persalinan</label>
                            <input type="text" id="jenis_persalinan" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Penolong Persalinan</label>
                            <input type="text" id="penolong_persalinan" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Penyulit</label>
                            <input type="text" id="penyulit" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Jenis Kelamin / Berat Lahir</label>
                            <input type="text" id="kelamin_bb" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Keadaan Anak Sekarang</label>
                            <input type="text" id="keadaan" class="form-control" required>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form action="#" id="form_riwayat_kehamilan" onsubmit="return ubah_riwayat_kehamilan()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Tahun Partus</label>
                            <input type="number" id="ubah_tahun_partus" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Tempat Partus</label>
                            <input type="tetxt" id="ubah_tempat_partus" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Umur Hamil</label>
                            <input type="text" id="ubah_umur_hamil" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Jenis Persalinan</label>
                            <input type="text" id="ubah_jenis_persalinan" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Penolong Persalinan</label>
                            <input type="text" id="ubah_penolong_persalinan" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Penyulit</label>
                            <input type="text" id="ubah_penyulit" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Jenis Kelamin / Berat Lahir</label>
                            <input type="text" id="ubah_kelamin_bb" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Keadaan Anak Sekarang</label>
                            <input type="text" id="ubah_keadaan" class="form-control" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success">Simpan</button>
    ...
    <form action="{{ url('e_rekam_medis/rekam_medis/save_asesmen_awal_kebidanan_rawat_inap') }}" method="post"
        id="hidden_form">
        @csrf
        <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
    ...
    @endif
    <form class="container" id="form_not_submitted" onsubmit="return check_all_field()">
        <div class="row">
        ...
        <div class="row" style="border: 1px solid;">
            ...
            <div class="col-md-6 pt-2 pb-2" style="border: 1px solid;">
                <table style="border-collapse: collapse; width: 100%">
                    <tr>
                        ...
                        <th style="width: 85%">
                            <select name="ruangan" id="ruangan" class="inputan" style="width: 100%" required>
                                <option value=""></option>
                    ...
                    <tr>
                        ...
                        <th style="padding-left: 10px; padding-right: 10px; width:5%;"> : </th>
                        <th style="width: 85%">
                            <select name="dpjp" id="dpjp" class="inputan" style="width: 100%" required>
                                <option value=""></option>
                                @foreach ($dokter as $d)
                                    <option value="{{ $d->nama }}"
            ...
            <div class="col-md-6"
                ...
                <h6 style="text-align: center; font-weight:bold;">Tanggal : <input required type="date"
                        class="inputan" value="{{ $layanan ? date('Y-m-d', strtotime($layanan->tanggal)) : '' }}"
                        name="tanggal">, Jam : <input type="time" required
                    ...
                    <tr>
                        ...
                        <th style="width: 25%;">
                            <input type="radio" name="rujukan"
                                ...
                                value="puskesmas" required> Puskesmas
                        </th>
                        <th style="width: 25%;">
                            <input type="radio" name="rujukan"
                        ...
                        <th style="width: 25%;">
                            ...
                            <input type="text"
                                ...
                                class="inputan"
                                {{ $dokumen->asesmen_awal_kebidanan_ranap ? ($dokumen->asesmen_awal_kebidanan_ranap->rujukan == 'lain_lain' ? 'required' : 'readonly') : 'readonly' }}
                                id="rujukan_lain">
                        </th>
                    </tr>
                    <tr>
            ...
            <div class="col-md-12 pt-2 pb-2" style="border: 1px solid; font-weight:bold;">
                ...
                <input type="text" class="inputan"
                    ...
                    {{ $dokumen->asesmen_awal_kebidanan_ranap ? ($dokumen->asesmen_awal_kebidanan_ranap->riwayat_alergi == 'ada' ? 'required' : 'readonly') : 'readonly' }}
            ...
            <div class="col-md-12 pt-2 pb-2" style="border: 1px solid;">
                <table style="border-collapse: collapse; width: 100%;">
                    <tr>
                        ...
                        <th style="width: 60%">
                            Skor Nyeri :
                            <select id="skor_nyeri" class="inputan" required style="width: 85%">
                                @for ($i = 0; $i <= 10; $i++)
                                    <option value="{{ $i }}"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 83%">
                                        ...
                                        <input style="margin-left: 50px;"
                                            ...
                                            type="radio" name="siklus_haid" required value="teratur"> Teratur
                                        <input style="margin-left: 50px;"
                                        ...
                                        Lama : <input type="number" id="hari_tidak_teratur"
                                            value="{{ $dokumen->asesmen_awal_kebidanan_ranap ? $dokumen->asesmen_awal_kebidanan_ranap->lama_hari_menarche : '' }}"
                                            {{ $dokumen->asesmen_awal_kebidanan_ranap ? ($dokumen->asesmen_awal_kebidanan_ranap->teratur_menarche == 'tidak_teratur' ? 'required' : 'readonly') : 'readonly' }}
                                            class="inputan" name="hari_tidak_teratur"> Hari
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th style="width: 83%">
                                        ...
                                        <input style="margin-left: 50px;"
                                            ...
                                            class="inputan"
                                            {{ $dokumen->asesmen_awal_kebidanan_ranap ? ($dokumen->asesmen_awal_kebidanan_ranap->keluhan == 'lain_lain' ? 'required' : 'readonly') : 'readonly' }}
                        ...
                        <th style="width: 95%">
                            ...
                            <table style="border-collapse: collapse; width:100%">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        Istri
                                        <input type="radio" name="jumlah_pernikahan_istri"
                                            style="margin-left: 37px;"
                                            {{ $jumlah_pernikahan[1]->istri == '1' ? 'checked' : '' }} value="1"
                                            required> 1X
                                        <input type="radio" name="jumlah_pernikahan_istri"
                                            style="margin-left: 50px;"
                                            {{ $jumlah_pernikahan[1]->istri == '2' ? 'checked' : '' }} value="2">
                                        2X
                                        <input type="radio" name="jumlah_pernikahan_istri"
                                            style="margin-left: 50px;"
                                            {{ $jumlah_pernikahan[1]->istri == '> 2' ? 'checked' : '' }}
                                            value="> 2"> > 2X
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        <input type="number" name="usia_perkawinan"
                                            ...
                                            style="border: none; border-bottom: 2px dotted; width:10%;" required> Tahun
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        <input type="text" id="keluarga_terdekat"
                                            ...
                                            style="border: none; border-bottom: 2px dotted; width:40%;" required>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        <input type="radio" name="tinggal_dengan"
                                            ...
                                            value="orang_tua" required> Orang
                                        Tua
                                        <input type="radio" name="tinggal_dengan"
                                        ...
                                        <input type="radio" name="tinggal_dengan"
                                            ...
                                            {{ $dokumen->asesmen_awal_kebidanan_ranap ? ($dokumen->asesmen_awal_kebidanan_ranap->tinggal_dengan == 'lain_lain' ? 'required' : 'readonly') : 'readonly' }}
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        <input type="radio"
                                            ...
                                            name="curiga_penganiayaan" value="tidak" required>
                                        Tidak
                                        <input type="radio"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68%">
                                        <input type="text" name="kegiatan_ibadah"
                                            ...
                                            style="border: none; border-bottom: 2px dotted; width:100%;" required>
                                    </th>
                                </tr>
                                <tr>
                    ...
                    <tr style="vertical-align: top;">
                        ...
                        <th style="width: 95%">
                            G : <input type="text" name="riwayat_kehamilan_g"
                                ...
                                style="border: none; border-bottom:2px dotted; width:25%; margin-right:50px;" required>
                            ...
                            A : <input type="text" name="riwayat_kehamilan_a"
                                ...
                                style="border: none; border-bottom:2px dotted; width:25%;" required>
                        </th>
                    </tr>
                </table>
            </div>
                    ...
                    <tr style="vertical-align: top;">
                        ...
                        <th style="width: 95%">
                            ...
                            <input type="text" id="riwayat_operasi"
                                ...
                                style="border: none; border-bottom:2px dotted; width:71%;" required>
                            Tahun : <input type="text" id="tahun_operasi"
                                ...
                                style="border: none; border-bottom:2px dotted; width:10%;" required>
                        </th>
                    </tr>
                    <tr style="vertical-align: top;">
                                ...
                                <tr>
                                    <th style="width: 20%">
                                        <input type="radio"
                                            ...
                                            name="riwayat_ginekologi" required value="infertilitas"> Infertilitas
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio"
                            ...
                            <table style="border-collapse: collapse; width:100%;">
                                <tr>
                                    ...
                                    <th style="width: 36%">BAK : <input type="text"
                                            ...
                                            id="bak" required class="inputan"> cc/hari,</th>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 36%">BAB : <input type="text"
                                            ...
                                            id="bab" required class="inputan"> x/hari,</th>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 36%">Tidur Malam : <input type="text"
                                            ...
                                            id="tidur_malam" required class="inputan"> Jam/Hari,</th>
            ...
            <div class="col-md-12 pt-2 pb-4" style="border: 1px solid;">
                ...
                <table style="border-collapse: collapse; width:100%;" class="tabel_subjektif">
                    ...
                    <tr>
                        <th></th>
                        <th>
                            Keadaan Umum : <input type="text" style="width: 25%" id="keadaan_umum" required
                                class="inputan"
                                value="{{ $layanan ? ($layanan->tanda_vital ? $layanan->tanda_vital->keadaan_umum : '') : '' }}">,
                            Kesadaran :
                            <select id="kesadaran" required class="inputan">
                            ...
                            {{-- <input type="text" style="width: 25%" name="kesadaran" required
                                class="inputan"
                                value="{{ $layanan ? ($layanan->tanda_vital ? $layanan->tanda_vital->kesadaran : '') : '' }}"> --}}
                            , BB/TB : <input type="number" required id="bb" style="width: 10%"
                                class="inputan"
                                value="{{ $layanan ? ($layanan->tanda_vital ? $layanan->tanda_vital->berat_badan : '') : '' }}">
                            / <input type="number" id="tb" style="width: 10%" required class="inputan"
                            ...
                            GCS : E : <input
                                ...
                                required type="text" id="gcs_e" class="inputan"
                            ...
                            V : <input type="text" id="gcs_v"
                                ...
                                required class="inputan" style="margin-right: 20px; width:25%">
                            M : <input
                                value="{{ $dokumen->asesmen_awal_kebidanan_ranap ? $dokumen->asesmen_awal_kebidanan_ranap->gcs_m : '' }}"
                                required style=" width:25%" type="text" id="gcs_m" class="inputan">
                        </th>
                    </tr>
                    <tr>
                        <th></th>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="kepala"
                                            ...
                                            value="misochepal" class="inputan" required> Misochepal
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="rambut"
                                            ...
                                            value="bersih" class="inputan" required> Bersih
                                    </th>
                                    <th colspan="3" style="width: 65%">
                                        <input type="radio" name="rambut"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="muka"
                                            ...
                                            value="normal" class="inputan" required> Normal
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="muka"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="mata"
                                            ...
                                            value="konjungtiva_merah" class="inputan" required> Konjungtiva Merah
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="mata"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="leher"
                                            ...
                                            value="pembesaran_limfe" class="inputan" required> Pembesaran Limfe
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="leher"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="dada"
                                            ...
                                            value="simetris" class="inputan" required> Simetris
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="dada"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="payudara"
                                            ...
                                            value="keluar_asi" class="inputan" required> Keluar ASI
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="payudara"
                                ...
                                <tr>
                                    ...
                                    <th style="width: 20%">
                                        <input type="radio" name="abdomen"
                                            ...
                                            value="luka_bekas_operasi" class="inputan" required> Luka Bekas Operasi
                                    </th>
                                    <th style="width: 20%">
                                        <input type="radio" name="abdomen"
            ...
            <div class="col-md-12 pt-2 pb-4" style="border: 1px solid;">
                ...
                <table style="border-collapse: collapse; width:100%;">
                    ...
                    <tr>
                        <th style="width: 100%" colspan="3">
                            <input type="radio" name="inspeksi"
                                ...
                                value="membesar" required> Membesar dengan arah
                            memanjang / melebar
                            <input style="margin-left: 50px;"
                    ...
                    <tr>
                        ...
                        <th style="width: 3%"> : </th>
                        <th style="width: 87%">
                            <input type="text" id="leopold_satu" value="{{ $palpasi[0] }}" required
                    ...
                    <tr>
                        ...
                        <th style="width: 3%"> : </th>
                        <th style="width: 87%">
                            <input type="text" id="leopold_dua" value="{{ $palpasi[1] }}" required
                                style="width: 100%" class="inputan">
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th style="width: 3%"> : </th>
                        <th style="width: 87%">
                            <input type="text" id="leopold_tiga" value="{{ $palpasi[2] }}" required
                                style="width: 100%" class="inputan">
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th style="width: 3%"> : </th>
                        <th style="width: 87%">
                            <input type="text" id="leopold_empat" value="{{ $palpasi[3] }}" required
                                style="width: 100%" class="inputan">
                        </th>
                    </tr>
                </table>
                <div class="pt-2" style="font-weight: bold">
                    <input type="radio" name="nyeri_obstetri"
                        ...
                        value="nyeri_tekan" required> Nyeri Tekan
                ...
                <table style="border-collapse: collapse; width:100%">
                    <tr>
                        ...
                        <th style="width: 30%">: <input type="text"
                                ...
                                id="tfu" style="width: 60%" class="inputan" required> cm</th>
                        <th style="width: 15%"></th>
                        <th style="width: 15%"></th>
                    ...
                    <tr>
                        ...
                        <th style="width: 30%">: <input type="text" id="tfj"
                                ...
                                style="width: 60%" class="inputan" required> gram</th>
                        <th style="width: 15%"></th>
                        <th style="width: 15%"></th>
                        <th style="width: 20%"></th>
                    </tr>
                    <tr>
                        ...
                        <th style="width: 30%">: <input id="his"
                                ...
                                type="text" style="width: 60%" class="inputan" required> x/10
                            menit</th>
                        <th style="width: 15%"><input type="radio"
                                ...
                                value="teratur" name="teratur_his" required> Teratur</th>
                        <th style="width: 15%"><input type="radio"
                    ...
                    <tr>
                        ...
                        <th style="width: 30%">: <input type="text" id="durasi" required
                        ...
                        <th style="width: 15%"><input type="radio"
                                ...
                                value="kuat" name="kriteria_durasi" required> Kuat</th>
                        <th style="width: 15%"><input type="radio"
                ...
                <table style="border-collapse: collapse; width:100%" class="tabel_subjektif">
                    <tr>
                        ...
                        <th><input type="radio"
                                ...
                                value="bersih" name="inspeksi_genitalia" required> Bersih</th>
                        <th><input type="radio"
                    ...
                    <tr>
                        ...
                        <th colspan="5">Banyaknya : <input type="text"
                                ...
                                name="pengeluaran" required class="inputan"> cc
                        </th>
                    </tr>
                    <tr>
                        <th></th>
                        ...
                        <th> : <input type="radio"
                                ...
                                value="encer" name="konsistensi" required> Encer</th>
                    ...
                    <tr>
                        ...
                        <th colspan="3"><input type="radio"
                                ...
                                value="infeksi" name="uretra" required> Infeksi</th>
                        <th colspan="3"><input type="radio"
                    ...
                    <tr>
                        ...
                        <th colspan="3"><input type="radio"
                                ...
                                value="pembengkakan" name="vulva" required> Pembengkakan Kelenjar
                            Bartholini
                        </th>
                        <th colspan="3"><input type="radio"
                    ...
                    <tr>
                        ...
                        <th colspan="3"><input type="radio"
                                ...
                                value="licin" name="vagina" required> Licin</th>
                        <th colspan="3"><input type="radio"
                    ...
                    <tr>
                        ...
                        <th><input type="radio"
                                ...
                                value="tebal" name="portio" required> Tebal</th>
                        <th><input type="radio"
                    ...
                    <tr>
                        ...
                        <th colspan="2"><input type="text"
                                ...
                                class="inputan" id="pembukaan" required> cm
                        </th>
                        <th><input type="radio"
                    ...
                    <tr>
                        ...
                        <th colspan="3"><input type="radio"
                                ...
                                value="srld" name="selaput" required> SRLD : <input style="width:75%;"
                                type="text"
                    ...
                    <tr>
                        ...
                        <th colspan="6"><input style="width:100%;"
                                ...
                                type="text" required id="bg_terendah" class="inputan"></th>
                    </tr>
                    <tr>
                        <th>UUK</th>
                        <th> : </th>
                        <th colspan="6"><input style="width:100%;" type="text"
                                ...
                                required id="uuk" class="inputan"></th>
                    </tr>
                    <tr>
                        <th>Penurunan</th>
                        <th> : </th>
                        <th><input type="radio"
                                ...
                                name="penurunan" value="h_i" required> H I</th>
                        <th><input type="radio"
                    ...
                    <tr>
                        ...
                        <th><input type="radio"
                                ...
                                value=">=6" name="bishope_score" required> ≥ 6</th>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="list_hasil_lab">
                                            ...
                                            if (isset($layanan->pesanan_lab[0])) {
                                                $cek = false;
                                                $temp = json_decode($layanan->pesanan_lab[0]->hasil);
                                                $hasil = json_decode($layanan->pesanan_lab[0]->hasil, true);
                                                $key_hasil = $hasil ? array_keys($hasil) : [];
                                                ...
                                                if ($cek) {
                                                    $temp_grup = '';
                                                    for ($i = 0; $i < sizeof($master_hasil); $i++) {
                                                        // dd($hasil[$master_hasil[$i]->slug]);
                                                        if ($hasil[$master_hasil[$i]->slug] != '') {
                                                            if ($temp_grup != $master_hasil[$i]->grup) {
                                                                $ins .= '<tr>' . '<th colspan="3">' . $master_hasil[$i]->grup . '</th>' . '</tr>';
                                                                $temp_grup = $master_hasil[$i]->grup;
                                                            }
                                                            $ins .= '<tr>' . '<td style="padding-left: 40px">' . $master_hasil[$i]->name . '</td>' . '<td class="text-center">' . $hasil[$master_hasil[$i]->slug] . '</td>' . '<td class="text-center">' . $master_hasil[$i]->nt . '</td>' . '</tr>';
                                                        }
                                                    }
                                                } else {
                                ...
                                @if ($layanan->pesanan_radiologi)
                                    ...
                                    <table>
                                        ...
                                        if (isset($layanan->pesanan_radiologi[0])) {
                                            ...
                                            $key_periksa = $periksa ? array_keys($periksa) : [];
                                            ...
                                            for ($i = 0; $i < sizeof($hasil); $i++) {
                                                ...
                                                if ($hasil[$temp_slug] != '') {
                                                    for ($j = 0; $j < sizeof($key_periksa); $j++) {
            ...
            <div class="col-md-12 pt-2 pb-4" style="border: 1px solid;">
                ...
                <input type="text" class="inputan"
                    ...
                    id="diagnosa_kebidanan" required style="width: 100%">
            </div>
            <div class="col-md-12 pt-2" style="border: 1px solid;">
                <h6>D. RENCANA ASUHAN KEBIDANAN</h6>
                <textarea id="rencana" style="width: 100%" rows="10" required>{{ $dokumen->asesmen_awal_kebidanan_ranap ? $dokumen->asesmen_awal_kebidanan_ranap->rencana : '' }}</textarea>
            </div>
