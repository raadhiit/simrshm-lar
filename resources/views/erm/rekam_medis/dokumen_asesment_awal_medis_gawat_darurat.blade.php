            ...
            <tr>
                ...
                <td style="border-left: hidden">
                    <input onclick="cek_radio_cara_masuk()"
                           ...
                           @else
                               {{ $dokumen->dokumen_asesment_awal_medis_gawat_darurat ? ($dokumen->dokumen_asesment_awal_medis_gawat_darurat->cara_masuk == 'sendiri' ? 'checked' : '') : '' }}
                           @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input onclick="cek_radio_cara_bayar()"
                                ...
                                @else
                                    {{ $dokumen->dokumen_asesment_awal_medis_gawat_darurat ? ($dokumen->dokumen_asesment_awal_medis_gawat_darurat->cara_bayar == 'bpjs' ? 'checked' : '') : '' }}
                                @endif
            ...
            <tr>
                ...
                <td>
                    ...
                    {{-- <input type="text" class="form-control" style="border: hidden; border-bottom: 2px dotted"
                                   value="@if(old('konsultasi')){{ old('konsultasi') }}@else{{ $dokumen->dokumen_asesment_awal_medis_gawat_darurat ? $dokumen->dokumen_asesment_awal_medis_gawat_darurat->konsultasi : '' }}@endif"
                                   id="konsultasi"> --}}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <input @if(old('pulang'))
                        ...
                        @else
                            {{ $dokumen->dokumen_asesment_awal_medis_gawat_darurat ? ($dokumen->dokumen_asesment_awal_medis_gawat_darurat->pulang == 'izin_dokter' ? 'checked' : '') : '' }}
                        @endif
...
<script>
    ...
    var sig = new signaturePad(document.getElementById('sig'), {
