...
<head>
    ...
    <title>Lembar Observasi Keperawatan IGD</title>
...
<body>
    ...
    @endif
    <div class="container">
        <div class="modal fade" id="modal_simpan" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" onsubmit="return cek_form(this)"
                        action="{{ url('e_rekam_medis/detail/save_observasi_keperawatan_igd') }}">
                        @csrf
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="tgl_tindakan" id="tgl_tindakan"
                                    class="fulldate form-control">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="modal_petugas" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="post"
                        action="{{ url('e_rekam_medis/detail/verifikasi_observasi_keperawatan_igd') }}">
                        @csrf
                        <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
        ...
        <div class="modal fade" id="modal_pasien" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form method="POST" onsubmit="return konfirmasi_ttd(this)"
                        action="{{ url('e_rekam_medis/detail/save_ttd_dokumen_kunjungan') }}">
                        <div class="modal-body">
                            @csrf
                            <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
                            <div class="col-md-12">
                                ...
                                <div class="form-group text-center">
                                    <h6>Signature :</h6>
                                    <canvas style="border: 2px solid;" id="signature-pad" class="signature-pad"
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <p style="font-weight: bold; font-size: 12px;">Jl. Raya Cibarusah No. 05 Kebon Kopi, Kel. Cibarusah
                    Jaya, Kec. Cibarusah<br>
                ...
                <div style="width: 100%; padding:10px; border: 1px solid; border-radius:10px;">
                    <table>
                        ...
                        <tr>
                            <td>Jenis Kelamin</td>
                            <td class="pl-2 pr-2"> : </td>
                            <td>{{ $pasien->kelamin == 0 ? 'Laki-Laki' : ($pasien->kelamin == 1 ? 'Perempuan' : '') }}
                            </td>
                        </tr>
                        <tr>
                            <td>NIK</td>
            ...
            <table class="table table-bordered table-0 custom-table">
                <thead>
                    <tr>
                        <th scope="col" colspan="4" class="text-center"
                            style="background-color: lightgrey; margin-bottom:0; border-color: black;">
                ...
                <tbody>
                    <tr class="text-center mt-2">
                        ...
                        <td class="font-weight-bold" style="width: 60%; vertical-align: middle">TINDAKAN KEPERAWATAN
                        </td>
                        ...
                        <td class="font-weight-bold" style="width: 10%; vertical-align: middle">
                            <button class="btn btn-primary btn-sm" onclick="open_modal_simpan(0)"><i
                    ...
                    @if (isset($data))
                        @foreach ($data as $item)
                            <tr>
                                <td id="isian_tgl_tindakan_{{ $item->id }}">
                                    {{ date('d-m-Y H:i', strtotime($item->tgl_tindakan)) }}</td>
                                ...
                                {{-- <td style="text-align: center">
                                    ...
                                    <a onclick="if (confirm('Apakah Anda yakin akan menghapus?')){return true;}else{event.stopPropagation(); event.preventDefault();};" href="{{ url('e_rekam_medis/detail/hapus_observasi_keperawatan_igd') }}/{{ $item->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    @endif
                                </td> --}}
                                ...
                                <td style="text-align: center">
                                    <button class="btn btn-success btn-sm"
                                        onclick="open_modal_simpan('{{ $item->id }}')"><i
                                            class="fa fa-pencil"></i></button>
                                    <a onclick="if (confirm('Apakah Anda yakin akan menghapus?')){return true;}else{event.stopPropagation(); event.preventDefault();};"
                                        href="{{ url('e_rekam_medis/detail/hapus_observasi_keperawatan_igd') }}/{{ $item->id }}"
