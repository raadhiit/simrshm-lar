...
<head>
    ...
    <title>Formulir Skrining Awal Gizi Anak</title>
...
{{-- 
        ...
        <div class="container">
            <h5 class="text-center mt-3 font-weight-bold"> FORMULIR SKRINING AWAL GIZI ANAK</h5>
            <p class="font-weight-bold mt-3">A. Parameter untuk Skrining Gizi Pasien Anak (Strong Kids) <br>
            ...
            <table class="table table-bordered custom-table">
                <thead>
                  <tr>
                    <th scope="col" colspan="3" style="border-color: black; background-color: #cbcbcb">Mengobservasi Apakah Pasien Tampak Kekurangan Gizi</th>
                  </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="width: 80%">&nbsp;&nbsp;Tidak</td>
                    ...
                    <tr>
                        <th scope="col" colspan="3" style="border-color: black; background-color: #cbcbcb">Menanyakan Apakah Pasien Memiliki Penyakit yang Menyebabkan Pasien Berisiko Malnutrisi (Anoreksia, Gizi Kurang, Gizi Buruk, Penyakit Degeneratif Lain yang Berkaitan/TB Paru )</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="col" colspan="3" style="border-color: black; background-color: #cbcbcb">Menanyakan Suatu Kondisi Kepada Pasien</th>
                    </tr>
                    <tr>
                        <td style="width: 80%">&nbsp;&nbsp;Mengalami diare 2-5 kali/hari atau muntah >= 3 kali perhari</td>
                        <td style="width: 10%; text-align: center">&nbsp;&nbsp;1</td>
                        <td style="width: 10%; text-align: center">
                    ...
                    <tr>
                        <td style="width: 80%">&nbsp;&nbsp;Mengalami penurunan asupan makanan seminggu terakhir</td>
                        <td style="width: 10%; text-align: center">&nbsp;&nbsp;1</td>
                        <td style="width: 10%; text-align: center">
                    ...
                    <tr>
                        <td style="width: 80%">&nbsp;&nbsp;Sedang mendapatkan terapi gizi</td>
                        <td style="width: 10%; text-align: center">&nbsp;&nbsp;1</td>
                        <td style="width: 10%; text-align: center">
                    ...
                    <tr>
                        <th scope="col" colspan="3" style="border-color: black; background-color: #cbcbcb">Menanyakan Penurunan Berat Badan Kepada Pasien Selama Satu Bulan Terakhir</th>
                    </tr>
                    <tr>
                        <td style="width: 80%">&nbsp;&nbsp;Ada</td>
                        <td style="width: 10%; text-align: center">&nbsp;&nbsp;1</td>
                    ...
                    <tr>
                        <td scope="col" colspan="3" >
                            &nbsp;&nbsp;Apabila skor >= 1 maka dilakukan assessment gizi tingkat lanjut oleh ahli gizi
                        </td>
                    </tr>
                </tbody>     
            </table>  
    ...
    <div class="modal fade" id="modal_verifikasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('e_rekam_medis/detail/formulir_skrining_awal_gizi_anak/verifikasi') }}" method="post">
                    @csrf
                    <input type="hidden" name="dokumen" value="{{ $dokumen->id }}">
...
<script>
      $('#form_dokumen').submit(function(e) {
        ...
        $.ajax({
            url: "{{ url('e_rekam_medis/detail/formulir_skrining_awal_gizi_anak/store') }}",
