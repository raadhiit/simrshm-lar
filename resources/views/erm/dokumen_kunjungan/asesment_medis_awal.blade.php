...
<body style="margin: 20px;">
    ...
    <form action="#" onsubmit="return fake_submit()" id="formulir">
        <div style="border:1px solid; margin-top: -17px;">
            ...
            <p>* Beri tanda &#9989 pada tanda <input type="checkbox"  disabled></p>
            <table class="table_isian" style="border-collapse:collapse; border: 1px solid; width: 100%;">
                ...
                <tr>
                    ...
                    <td colspan="4">
                       ...
                       @else
                        ...
                        koma/Koma,
                        <input type="text"  {{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->kesadaran == 'sopor_koma' ? '' : '' : '' }}
                            ...
                            @if (old('kesadaran')) {{ old('kesadaran') == 'sopor_koma' ? '' : '' }}
                    @else
                    {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->kesadaran == 'sopor_koma' ? '' : '') : '' }} @endif>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" style="padding-left: 10px">
                       ...
                       @else
                        ...
                        <input type="number"  {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->saudara == 'kandung' ? '' : '') : '' }}
                            value="{{ old('ket_kandung') ? old('ket_kandung') : ($dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->ket_kandung : '') }}"
                    ...
                    <td colspan="3" style="border-left: hidden">
                       ...
                       @else
                        ...
                        <input type="number" value="{{ old('ket_tiri') ? old('ket_tiri') : ($dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->ket_tiri : '') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               ...
                               @else
                                ...
                                <input type="text" id="ket_tinggal_lainnya" value="{{ old('ket_tinggal_lainnya') ? old('ket_tinggal_lainnya') : ($dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->ket_tinggal_lainnya : '') }}"
                            ...
                            <div class="col-md-4">
                               ...
                               @else
                                ...
                                <input type="number" id="tahun_gangguan_jiwa" 
                                    value="{{ old('tahun_gangguan_jiwa') ? old('tahun_gangguan_jiwa') : ($dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->tahun_gangguan_jiwa : '') }}"
                                    style="border: 0; border-bottom: 2px dotted;">
                            </div>
                        </div>
                    </td>
                            ...
                            <div class="col-md-8">
                               ...
                               @else
                                ...
                                <input type="text" 
                                    ...
                                    @if (old('riwayat_trauma')) {{ old('riwayat_trauma') == 'kriminal' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->riwayat_trauma == 'kriminal' ? '' : '') : '' }} @endif>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               ...
                               @else
                                ...
                                <input type="text" id="agama_spiritual" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->kebutuhan_spiritual == 'ya' ? '' : '') : '' }}
                                    ...
                                    style="border: 0; border-bottom: 2px dotted;"
                                    @if (old('kebutuhan_spiritual')) {{ old('kebutuhan_spiritual') == 'ya' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->kebutuhan_spiritual == 'ya' ? '' : '') : '' }} @endif>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               ...
                               @else
                                ...
                                <input type="text"  {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->pekerjaan == 'lain_lain' ? '' : '') : '' }}
                                    ...
                                    @if (old('pekerjaan')) {{ old('pekerjaan') == 'lain_lain' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->pekerjaan == 'lain_lain' ? '' : '') : '' }} @endif>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr style="border-bottom: hidden">
                    ...
                    <td colspan="3">
                        Sifat :
                        <input {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->nyeri == 'ya' ? '' : '') : '' }}
                ...
                <tr>
                    <td colspan="6">
                        ...
                        <div class="row">
                            ...
                            <div>:</div>
                            <div class="col-md-2">
                                <input onclick="cek_radio_nyeri_menjalar()" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->nyeri == 'ya' ? '' : '') : '' }}
                        ...
                        @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->nyeri_menjalar == 'ya' ? 'checked' : '') : '' }} @endif
                                ...
                                <input type="text" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->nyeri_menjalar == 'ya' ? '' : '') : '' }}
                                    ...
                                    @if (old('nyeri_menjalar')) {{ old('nyeri_menjalar') == 'ya' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->nyeri_menjalar == 'ya' ? '' : '') : '' }} @endif>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                               ...
                               @else
                                   {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->frekuensi_nyeri == 'jarang' ? 'checked' : '') : '' }} @endif
                ...
                <tr style="border-bottom: hidden">
                    <td colspan="6">
                       ...
                       @else
                        ...
                        <input type="time"  {{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->beritahu_dokter == 'ya' ? '' : '' : '' }}
                            value="{{ old('jam_diberitahukan') ? old('jam_diberitahukan') : ($dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->jam_diberitahukan : '') }}"
                ...
                <tr>
                    ...
                    <td style="border-left: hidden; border-right: hidden">:</td>
                    <td colspan="4">
                        <textarea  id="hasil_resiko_jatuh" class="form-control" rows="5" class="form-control">
@if (old('hasil_skrining_resiko_jatuh')){{ old('hasil_skrining_resiko_jatuh') }}@else{{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->hasil_skrining_resiko_jatuh : '' }}@endif
                ...
                <tr>
                    ...
                    <td style="border-left: hidden; border-right: hidden">:</td>
                    <td colspan="4">
                        <textarea  id="saran_resiko_jatuh" class="form-control" rows="5" class="form-control">
@if (old('saran_resiko_jatuh')){{ old('saran_resiko_jatuh') }}@else{{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->saran_resiko_jatuh : '' }}@endif
                ...
                <tr>
                    ...
                    <td style="border-left: hidden; border-right: hidden">:</td>
                    <td colspan="4">
                        <textarea  id="hasil_skrining_gizi" class="form-control" rows="5" class="form-control">
@if (old('hasil_skrining_gizi')){{ old('hasil_skrining_gizi') }}@else{{ $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->hasil_skrining_gizi : '' }}@endif
                ...
                <tr>
                    ...
                    <td style="border-left: hidden; border-right: hidden">:</td>
                    <td colspan="4">
                        <textarea  id="saran_skrining_gizi" class="form-control" rows="5" class="form-control">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <textarea  id="status_generalis" class="form-control" rows="5" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               ...
                               @else
                                ...
                                <input type="date" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->kontrol_ulang == 'ya' ? '' : '') : '' }}
                                    ...
                                    @if (old('kontrol_ulang')) {{ old('kontrol_ulang') == 'ya' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->kontrol_ulang == 'ya' ? '' : '') : '' }} @endif>
                            </div>
                            <div class="col-md-3">
                                <input onclick="cek_radio_kontrol_ulang()"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                               ...
                               @else
                                ...
                                <input type="date" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->rujuk == 'rs' ? '' : '') : '' }}
                                    ...
                                    @if (old('rujuk')) {{ old('rujuk') == 'rs' ? '' : '' }}
                            @else
                            {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->rujuk == 'rs' ? '' : '') : '' }} @endif>
                            </div>
                        </div>
                        <div class="row">
                ...
                <tr>
                    <td colspan="4">
                       ...
                       @else
                        ...
                        karena :
                        <br>
                        <input type="text" class="form-control" {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->penyampaian_edukasi == 'tidak' ? '' : '') : '' }}
                            ...
                            @if (old('penyampaian_edukasi')) {{ old('penyampaian_edukasi') == 'tidak' ? '' : '' }}
                    @else
                    {{ $dokumen->asesment_medis_awal ? ($dokumen->asesment_medis_awal->penyampaian_edukasi == 'tidak' ? '' : '') : '' }} @endif>
                        <br>
                    </td>
                </tr>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal"  class="form-control"
                                value="{{ date('Y-m-d', strtotime($dokumen->created_at)) }}" >
                        </div>
                        <div class="form-group">
                ...
                <form id="form_e_resep">
                    ...
                    <div class="modal-body">
                        <div class="row" style="width: 100%; margin-left: 0;">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly value="{{ date('Y-m-d') }}" name="waktu"
                                        id="e_resep_waktu" type="date" >
                                </div>
                                <div class="form-group">
                                    <label for="">NRM</label>
                                    <input class="form-control" readonly name="nrm" id="e_resep_nrm" type="text"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="">Usia</label>
                                    <input class="form-control" readonly name="usia" id="e_resep_usia" type="text"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="">Asuransi</label>
                                    <input class="form-control" readonly name="asuransi" value="{{ $layanan->asuransi }}" id="e_resep_asuransi"
                                        type="text" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" readonly name="dokter"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly name="nama" id="e_resep_nama" type="text"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="">Berat Badan</label>
                                    <input class="form-control" readonly name="berat_badan"
                                        value="{{ $layanan->tanda_vital ? $layanan->tanda_vital->berat_badan : '' }}"
                                        id="e_resep_berat_badan" type="text" >
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">SIP</label>
                                    <input class="form-control" readonly name="sip" id="e_resep_sip" value="{{ Session::has('sip') ? Session::get('sip') : '' }}" type="text"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat</label>
                                    <input class="form-control" readonly name="alamat" id="e_resep_alamat"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Jenis Pasien</label>
                                    <input class="form-control" readonly name="jenis_pasien" id="e_resep_jenis_pasien"
                                        type="text" >
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly name="noreg" value="{{ $dokumen->noreg }}"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">No. Telp</label>
                                    <input class="form-control" readonly name="telp" id="e_resep_telp" type="text"
                                        >
                                </div>
                                <div class="form-group">
                                    <label for="">Perusahaan</label>
                                    <input class="form-control" readonly name="perusahaan" value="{{ $layanan->nama_perusahaan }}" id="e_resep_perusahaan"
                                        type="text" >
                                </div>
                                {{-- <div class="form-group">
                        ...
                        <div class="row pt-3" style="width: 100%; margin-left: 0;">
                            <input type="hidden" id="e_resep_id_obat"  class="form-control">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Kode</label>
                                    <input type="text" readonly id="e_resep_kode_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly id="e_resep_jenis_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Sisa</label>
                                    <input type="text" readonly id="e_resep_sisa_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Satuan</label>
                                    <input type="text" readonly id="e_resep_satuan_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly id="e_resep_harga_obat"  class="form-control">
                                    <input type="hidden" id="e_resep_markup"  class="form-control">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="form_edit_resep">
                    ...
                    <div class="modal-body">
                        <div class="row" style="width: 100%; margin-left: 0;">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Waktu</label>
                                    <input class="form-control" readonly value="{{ date('Y-m-d') }}" name="waktu"
                                        id="edit_resep_waktu" type="date" >
                                </div>
                                <div class="form-group">
                                    <label for="">NRM</label>
                                    <input class="form-control" readonly name="nrm" id="edit_resep_nrm"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Usia</label>
                                    <input class="form-control" readonly name="usia" id="edit_resep_usia"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Asuransi</label>
                                    <input class="form-control" readonly value="{{ $layanan->asuransi }}"name="asuransi" id="edit_resep_asuransi"
                                        type="text" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    <label for="">Nama</label>
                                    <input class="form-control" readonly name="nama" id="edit_resep_nama"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Berat Badan</label>
                                    <input class="form-control" readonly name="berat_badan"
                                        value="{{ $layanan->tanda_vital ? $layanan->tanda_vital->berat_badan : '' }}"
                                        id="edit_resep_berat_badan" type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Depo Tujuan</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">SIP</label>
                                    <input class="form-control" readonly name="sip" id="edit_resep_sip"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat</label>
                                    <input class="form-control" readonly name="alamat" id="edit_resep_alamat"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Jenis Pasien</label>
                                    <input class="form-control" readonly name="jenis_pasien" id="edit_resep_jenis_pasien"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Obat Racikan</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">No. Reg</label>
                                    <input class="form-control" readonly id="edit_resep_noreg" name="noreg"
                                        value="{{ $dokumen->noreg }}" type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">No. Telp</label>
                                    <input class="form-control" readonly name="telp" id="edit_resep_telp"
                                        type="text" >
                                </div>
                                <div class="form-group">
                                    <label for="">Perusahaan</label>
                                    <input class="form-control" readonly value="{{ $layanan->nama_perusahaan }}" name="perusahaan" id="edit_resep_perusahaan"
                                        type="text" >
                                </div>
                                {{-- <div class="form-group">
                                <label for="">Kategori</label>
                        ...
                        <div class="row pt-3" style="width: 100%; margin-left: 0;">
                            <input type="hidden" id="edit_resep_id_obat"  class="form-control">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Kode</label>
                                    <input type="text" readonly id="edit_resep_kode_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Obat</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label for="">Jenis</label>
                                    <input type="text" readonly id="edit_resep_jenis_obat" 
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Sisa</label>
                                    <input type="text" readonly id="edit_resep_sisa_obat"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Satuan</label>
                                    <input type="text" readonly id="edit_resep_satuan_obat" 
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Jumlah</label>
                                ...
                                <div class="form-group">
                                    <label for="">Harga (Rp.)</label>
                                    <input type="text" readonly id="edit_resep_harga_obat" 
                                        class="form-control">
                                    <input type="hidden" id="edit_resep_markup"  class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Signa</label>
...
{{-- LAB --}}
<script>
    let id_pesanan_lab = <?php echo $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->id_pesanan_lab : '0' ?>;
...
{{-- RADIOLOGI --}}
<script>
    let id_pesanan_rad = <?php echo $dokumen->asesment_medis_awal ? $dokumen->asesment_medis_awal->id_pesanan_rad : '0' ?>;
