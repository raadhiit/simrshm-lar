...
<body style="margin: 20px;">
    ...
    <form onsubmit="return cek_form(this)" id="form_persetujuan" action="{{ url('e_rekam_medis/detail/save_surat_permintaan_rawat_inap') }}" method="post">
        @csrf
        <input type="hidden" name="dokumen" value="{{$dokumen->id}}">
        ...
        <input type="hidden" id="hide_tanggal_ttd" name="tanggal_ttd">
    </form>
    @if ($errors->any())
        ...
        <div class="col-lg-6" style="width: 100%; margin-left: 0; padding:10px;">
            <table id="tabel_kop_identitas" style="border-collapse: collapse; font-size: 16px;">
                ...
                <tr>
                    ...
                    <td style="padding-left:10px; padding-right:10px"> :</td>
                    <td>
                        <input @if(old('unit')) {{ old('unit') ==  'igd' ? 'checked' : '' }} @else {{ $dokumen->surat_permintaan_rawat_inap ? ($dokumen->surat_permintaan_rawat_inap->unit == 'igd' ? 'checked' : '') : '' }} @endif type="radio" value="igd" name="radio_unit"> IGD
                        <input @if(old('unit')) {{ old('unit') ==  'rawat_inap' ? 'checked' : '' }} @else {{ $dokumen->surat_permintaan_rawat_inap ? ($dokumen->surat_permintaan_rawat_inap->unit == 'rawat_inap' ? 'checked' : '') : '' }} @endif type="radio" value="rawat_inap" name="radio_unit" class="ml-4"> Rawat Inap
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="col-md-12">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <input type="text" class="form-control" style="border: hidden" value="@if(old('indikasi_rawat')){{ old('indikasi_rawat') }}@else{{ $dokumen->surat_permintaan_rawat_inap ? $dokumen->surat_permintaan_rawat_inap->indikasi_rawat : '' }}@endif" id="indikasi_rawat">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <div class="input-group">
                            ...
                            <input type="text" readonly value="@if(old('dpjp')) {{ old('dpjp') }} @else {{ $dokumen->surat_permintaan_rawat_inap ? $dokumen->surat_permintaan_rawat_inap->dpjp : ''}} @endif" id="dpjp" class="form-control">
                            <div class="input-group-append">
                                <button class="btn btn-dark" type="button" onclick="open_modal_yth('dpjp')"><i class="fa fa-list"></i></button>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <div class="input-group">
                            ...
                            <input type="text" readonly value="@if(old('dokter_pengirim')) {{ old('dokter_pengirim') }} @else {{ $dokumen->surat_permintaan_rawat_inap ? $dokumen->surat_permintaan_rawat_inap->dokter_pengirim : ''}} @endif" id="dokter_pengirim" class="form-control">
                            <div class="input-group-append">
                                <button class="btn btn-dark" type="button" onclick="open_modal_yth('dokter_pengirim')"><i class="fa fa-list"></i></button>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <div class="input-group">
                            <input type="text" hidden id="id_kamar">
                            <input type="text" readonly value="{{ $dokumen->surat_permintaan_rawat_inap ? $dokumen->surat_permintaan_rawat_inap->kamar : ''}}" id="kamar" class="form-control">
                            <div class="input-group-append">
                                <button class="btn btn-dark" type="button" onclick="open_modal_kamar()"><i class="fa fa-list"></i></button>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <div class="input-group">
                            <input type="text" hidden id="id_petugas_ranap">
                            <input type="text" readonly value="{{ $dokumen->surat_permintaan_rawat_inap ? $dokumen->surat_permintaan_rawat_inap->petugas_ranap : ''}}" id="petugas_ranap" class="form-control">
                            <div class="input-group-append">
                                <button class="btn btn-dark" type="button" onclick="open_modal_petugas_ranap()"><i class="fa fa-list"></i></button>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td style="width: 85%; border-bottom: 2px dotted">
                        <input type="date" class="form-control" id="tgl_rencana_operasi" value="@if(old('tgl_rencana_operasi')){{ old('tgl_rencana_operasi') }}
                    ...
                    <td colspan="3">
                        <div class="row pt-4" style="width:100%; margin-left: 0; ">
                            ...
                            <div class="col-md-6 text-center pt-2" style="padding-top: 20px; font-weight:bold;">
                                <p>Bekasi, <input type="text" style="border: hidden; border-bottom: 1px dotted" id="tanggal_ttd" class="tanggal_dmy" value="{{ $dokumen->surat_permintaan_rawat_inap ? ($dokumen->surat_permintaan_rawat_inap->tanggal_ttd != null || $dokumen->surat_permintaan_rawat_inap->tanggal_ttd != "" ? date('d-m-Y', strtotime($dokumen->surat_permintaan_rawat_inap->tanggal_ttd)) : '') : '' }}">
                                </p>
                    ...
                    <td colspan="3">
                        ...
                        <div class="row pb-5 pt-5" style="width:100%; margin-left:0;">
                            <div style="text-align: center;" class="col-md-12">
                                @if($dokumen->id_verifikator != 0)
                                <a href="{{ url('e_rekam_medis/detail/pdf_surat_permintaan_rawat_inap?dokumen='.$dokumen->id) }}" class="btn btn-success" target="_blank">Download PDF</a>
                                @endif
                            </div>
                        </div>
                    </td>
    ...
    <div class="modal fade" id="modal_petugas_ranap" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_kamar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    ...
    function cek_form() {
        ...
        $('#hide_tanggal_ttd').val($('#tanggal_ttd').val());
        return true;
    }
</script>
