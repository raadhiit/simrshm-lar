...
<form onsubmit="return cek_form(this)" id="form_persetujuan"
      action="{{ url('e_rekam_medis/detail/save_resume_medis_pasien_pulang') }}" method="post">
    @csrf
    <input type="hidden" name="dokumen" value="{{$dokumen->id}}">
    ...
    <input type="hidden" id="hide_diagnosa_primer" name="diagnosa_primer">
    <input type="hidden" id="hide_icd_primer" name="icd_primer">

    <input type="hidden" id="hide_diagnosa_sekunder" name="diagnosa_sekunder">
    <input type="hidden" id="hide_icd_sekunder" name="icd_sekunder">

    <input type="hidden" id="hide_diagnosa_sekunder2" name="diagnosa_sekunder2">
    <input type="hidden" id="hide_icd_sekunder2" name="icd_sekunder2">

    <input type="hidden" id="hide_diagnosa_sekunder3" name="diagnosa_sekunder3">
    <input type="hidden" id="hide_icd_sekunder3" name="icd_sekunder3">

    <input type="hidden" id="hide_diagnosa_sekunder4" name="diagnosa_sekunder4">
    <input type="hidden" id="hide_icd_sekunder4" name="icd_sekunder4">

    <input type="hidden" id="hide_diagnosa_sekunder5" name="diagnosa_sekunder5">
    <input type="hidden" id="hide_icd_sekunder5" name="icd_sekunder5">

    <input type="hidden" id="hide_diagnosa_penyerta1" name="diagnosa_penyerta1">
    <input type="hidden" id="hide_icd_penyerta1" name="icd_penyerta1">

    <input type="hidden" id="hide_diagnosa_penyerta2" name="diagnosa_penyerta2">
    <input type="hidden" id="hide_icd_penyerta2" name="icd_penyerta2">

    <input type="hidden" id="hide_diagnosa_penyerta3" name="diagnosa_penyerta3">
    <input type="hidden" id="hide_icd_penyerta3" name="icd_penyerta3">

    <input type="hidden" id="hide_diagnosa_penyerta4" name="diagnosa_penyerta4">
    <input type="hidden" id="hide_icd_penyerta4" name="icd_penyerta4">

    <input type="hidden" id="hide_diagnosa_penyerta5" name="diagnosa_penyerta5">
    <input type="hidden" id="hide_icd_penyerta5" name="icd_penyerta5">

    <input type="hidden" id="hide_pemeriksaan_lainnya" name="pemeriksaan_lainnya">
    <input type="hidden" id="hide_tindakan_prosedur" name="tindakan_prosedur">
    ...
    <div class="row" style="width: 100%; margin-left: 0;">
        <table style="width: 100%;" class="table_isian_bordered">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    <u>Tanggal Keluar RS</u> : 
                    {{-- <input style="margin-top: 5px; border: hidden; border-bottom: 1px dotted" type="date" name="tgl_keluar" id="tgl_keluar"
                    ...
                    <input value="{{ $dokumen->resume_medis_pasien_pulang->tgl_keluar ?? '' }}" type="date" name="tgl_keluar"
                    id="tgl_keluar" style="margin-top: 5px; border: hidden; border-bottom: 1px dotted">
                    <br>
                    Date of discharge
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="checkbox" @if(isset($dokumen->resume_medis_pasien_pulang))
                            {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_ct_scan',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? 'checked' : '') : '' }}
                            @endif id="pemeriksaan_penunjang_ct_scan"> CT Scan
                    <input type="checkbox" @if(isset($dokumen->resume_medis_pasien_pulang))
                            {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_usg',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang )) ? 'checked' : '') : '' }}
                            @endif id="pemeriksaan_penunjang_usg"> USG
                    <input type="checkbox" @if(isset($dokumen->resume_medis_pasien_pulang))
                            {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_ekg',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang )) ? 'checked' : '') : '' }}
                            @endif id="pemeriksaan_penunjang_ekg"> EKG
                    <input type="checkbox" @if(isset($dokumen->resume_medis_pasien_pulang))
                            {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_echocardiography',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang )) ? 'checked' : '') : '' }}
                    ...
                    <input onclick="cek_pemeriksaan_penunjang()" type="checkbox" @if(isset($dokumen->resume_medis_pasien_pulang))
                        {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_lain_lain',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang )) ? 'checked' : '') : '' }}
                    ...
                    <input type="text"
                        ...
                        {{ is_array(json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang)) ? (in_array('pemeriksaan_penunjang_lain_lain',json_decode($dokumen->resume_medis_pasien_pulang->pemeriksaan_penunjang )) ? '' : 'readonly') : 'readonly' }}
                        @else
                        readonly
                        @endif>
                </td>
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-8" style="border-right: 1px solid">
                            Diagnosis primer (Primary Diagnose): <input type="text" name="diagnosa_primer" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->diagnosa_primer : '' }}" id="diagnosa_primer" class="form-control">
                        ...
                        <div class="col-md-4">
                            Kode ICD X :
                            <input type="text" id="icd_primer" name="icd_primer" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_primer : '' }}" class="form-control">
                            <!-- <br>
                            <div id="box_diagnosa" class="ml-2">
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-8" style="border-right: 1px solid">
                            ...
                            <br>
                            <input placeholder="Diagnosa Sekunder 1" type="text" name="diagnosa_sekunder" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->diagnosa_sekunder : '' }}" id="diagnosa_sekunder" class="form-control diagnosa_sekunder">
                            <br>
                            <input placeholder="Diagnosa Sekunder 2" type="text" name="diagnosa_sekunder2" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_sekunder2 ?? '' }}" id="diagnosa_sekunder2" class="form-control diagnosa_sekunder">
                            <br>
                            <input placeholder="Diagnosa Sekunder 3" type="text" name="diagnosa_sekunder3" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_sekunder3 ?? '' }}" id="diagnosa_sekunder3" class="form-control diagnosa_sekunder">
                            <br>
                            <input placeholder="Diagnosa Sekunder 4" type="text" name="diagnosa_sekunder4" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_sekunder4 ?? '' }}" id="diagnosa_sekunder4" class="form-control diagnosa_sekunder">
                            <br>
                            <input placeholder="Diagnosa Sekunder 5" type="text" name="diagnosa_sekunder5" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_sekunder5 ?? '' }}" id="diagnosa_sekunder5" class="form-control diagnosa_sekunder">
                            <br>
                            Diagnosis Penyerta (Comorbide Diagnose)
                            <br>
                            <input placeholder="Diagnosa Penyerta 1" type="text" name="diagnosa_penyerta1" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_penyerta1 ?? '' }}" id="diagnosa_penyerta1" class="form-control diagnosa_penyerta">
                            <br>
                            <input placeholder="Diagnosa Penyerta 2" type="text" name="diagnosa_penyerta2" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_penyerta2 ?? '' }}" id="diagnosa_penyerta2" class="form-control diagnosa_penyerta">
                            <br>
                            <input placeholder="Diagnosa Penyerta 3" type="text" name="diagnosa_penyerta3" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_penyerta3 ?? '' }}" id="diagnosa_penyerta3" class="form-control diagnosa_penyerta">
                            <br>
                            <input placeholder="Diagnosa Penyerta 4" type="text" name="diagnosa_penyerta4" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_penyerta4 ?? '' }}" id="diagnosa_penyerta4" class="form-control diagnosa_penyerta">
                            <br>
                            <input placeholder="Diagnosa Penyerta 5" type="text" name="diagnosa_penyerta5" value="{{ $dokumen->resume_medis_pasien_pulang->diagnosa_penyerta5 ?? '' }}" id="diagnosa_penyerta5" class="form-control diagnosa_penyerta">
                            <br>
                            <!-- <div id="box_diagnosa" class="ml-2">
                        ...
                        <div class="col-md-4">
                            Kode ICD X :
                            <input type="text" name="icd_sekunder" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_sekunder : '' }}" id="icd_sekunder" class="form-control">
                            <br>
                            <input type="text" name="icd_sekunder2" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_sekunder2 : '' }}" id="icd_sekunder2" class="form-control">
                            <br>
                            <input type="text" name="icd_sekunder3" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_sekunder3 : '' }}" id="icd_sekunder3" class="form-control">
                            <br>
                            <input type="text" name="icd_sekunder4" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_sekunder4 : '' }}" id="icd_sekunder4" class="form-control">
                            <br>
                            <input type="text" name="icd_sekunder5" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_sekunder5 : '' }}" id="icd_sekunder5" class="form-control">
                            <br>
                            <br>
                            <input type="text" name="icd_penyerta1" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_penyerta1 : '' }}" id="icd_penyerta1" class="form-control">
                            <br>
                            <input type="text" name="icd_penyerta2" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_penyerta2 : '' }}" id="icd_penyerta2" class="form-control">
                            <br>
                            <input type="text" name="icd_penyerta3" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_penyerta3 : ''}}" id="icd_penyerta3" class="form-control">
                            <br>
                            <input type="text" name="icd_penyerta4" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_penyerta4 : '' }}" id="icd_penyerta4" class="form-control">
                            <br>
                            <input type="text" name="icd_penyerta5" value="{{$dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->icd_penyerta5 : ''}}" id="icd_penyerta5" class="form-control">
                            <!-- <br> -->
                            <!-- <div id="box_diagnosa" class="ml-2">
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-8" style="border-right: 1px solid">
                            ...
                            <textarea name="tindakan_prosedur" id="tindakan_prosedur" cols="30" rows="5" class="form-control">{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->tindakan_prosedur : '' }}</textarea>
                            <!-- <br>
                            <div>
                                @if (isset($tindakan))
            ...
            <tr>
                <td colspan="2">
                    Terapi / Pengobatan (Terapy / Treatment) :<br>
                    Selama Dirawat (Durante Treatment) :
                    <br>
                    <div id="list_e_resep" class="pt-3 pb-3 pl-2">
                ...
                @foreach ($all_resep as $ar)
                    <div style="page-break-inside: avoid;">
                        ...
                        <table style="border-collapse: collapse; width:50%;" class="tabel_resep">
                            @if (sizeof($all_resep))
                                @foreach ($all_resep as $ar)
                                    @foreach ($ar->detail as $ar_det)
                                        <tr>
                                            <td colspan="4" class="pl-2">{{ 'R/' }}</td>
                                        </tr>
                                        <tr>
                                            <td style="width:20px;"></td>
                                            <td class="pl-2">{{ $ar_det->nama_obat }}</td>
                                            <td class="text-center">{{ $ar_det->signa }}</td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <br>
                    <div id="list_e_resep_post_rawat" class="pt-3 pb-3 pl-2">
                        <div id="box_btn_terapi_post_rawat">
                            No. Resep Elektronik
                            @if (sizeof($resep_post_rawat))
                                @foreach ($resep_post_rawat as $ar)
                                    @if ($loop->iteration > 1)
                                        {{ ', ' . $ar->id }}
                                    @else
                                        {{ $ar->id }}
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input style="margin-top: 5px; border: hidden; border-bottom: 1px dotted" type="text" id="tgl_kontrol" 
                                class="tanggal_dmy" value="@if(old('tgl_kontrol')){{ old('tgl_kontrol') }}@else{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->tgl_kontrol : '' }}@endif">
                        </div>
                    </div>
                ...
                <td colspan="2">
                    <div class="row" style="padding-left: 15px">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="radio" name="kesadaran"
                                {{ $tanda_vital ? ($tanda_vital->kesadaran == 'komposmentis' ? 'checked' : '') : '' }}
                                value="komposmentis"> Komposmentis
                            <input type="radio" name="kesadaran"
                                {{ $tanda_vital ? ($tanda_vital->kesadaran == 'somnolen' ? 'checked' : '') : '' }}
                                value="somnolen"> Somnolen
                            <input type="radio" name="kesadaran"
                                {{ $tanda_vital ? ($tanda_vital->kesadaran == 'Sopor' ? 'checked' : '') : '' }}
                                value="Sopor"> Sopor
                            <input type="radio" name="kesadaran"
                                {{ $tanda_vital ? ($tanda_vital->kesadaran == 'Coma' ? 'checked' : '') : '' }}
                                value="Coma"> Coma
                        </div>
                        <div class="col-md-2">
                            TD <input type="text"
                    ...
                    <div class="row" style="padding-left: 15px">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $dokumen->resume_medis_pasien_pulang->pemeriksaan_lainnya ?? '' }}" type="text" class="form-control" name="pemeriksaan_lainnya"
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-6 text-center mt-2">
                            ...
                            Bekasi, <input type="date" name="tgl_dokumen" id="tgl_dokumen" style="border:1px solid transparent; border-bottom: 2px dotted; width: 40% background-color: transparent;" value="{{ $dokumen->resume_medis_pasien_pulang ? $dokumen->resume_medis_pasien_pulang->tgl_dokumen : '' }}"> 
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-6 text-center">
                            @if(is_null($dokumen->signature_pasien) || $dokumen->signature_pasien == "")
                                 <div class="col-md-4" onclick="open_modal_pasien()" style="margin:0 auto; height:150px; display: flex; align-items:center; justify-content: center;">
...
<div class="row pb-5 pt-5" style="width:100%; margin-left:0;">
    <div style="text-align: center;" class="col-md-12">
        @if($dokumen->id_verifikator != 0)
            <a href="{{ url('e_rekam_medis/detail/pdf_resume_medis_pasien_pulang?dokumen='.$dokumen->id) }}"
                ...
                <div class="modal-body">
                    ...
                    <div id="diagnosa">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="diagnosa" id="diagnosa_primerz">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $("#diagnosa_primer").autocomplete({
        ...
        onSelect: function(suggestion) {
            ...
            $("#icd_primer").val(suggestion.icd);
        }
    });

    $(".diagnosa_sekunder").autocomplete({
        serviceUrl: "{{ url('ajax_request/autocomplete_diagnosa') }}", // Kode php untuk prosesing data
        dataType: "JSON", // Tipe data JSON
        onSelect: function(suggestion) {
            var selectedElementId = $(this).attr('id');

            $("#" + selectedElementId).val(suggestion.nama);

            var lastChar = selectedElementId.charAt(selectedElementId.length - 1);
            if (lastChar == "r") {
                $("#icd_sekunder").val(suggestion.icd);
            }
            $("#icd_sekunder" + lastChar).val(suggestion.icd);
        }
    });

        $(".diagnosa_penyerta").autocomplete({
        serviceUrl: "{{ url('ajax_request/autocomplete_diagnosa') }}", // Kode php untuk prosesing data
        dataType: "JSON", // Tipe data JSON
        onSelect: function(suggestion) {
            var selectedElementId = $(this).attr('id');
            ...
            $("#icd_penyerta" + lastChar).val(suggestion.icd);
        }
    });
...
<script>
    ...
    function storeResumeMedis(){
        cek_form();

        var form = $('#form_persetujuan');
    ...
    function cek_form() {
        ...
        $('#hide_rr').val($('#rr').val());
        $('#hide_diagnosa_primer').val($('#diagnosa_primer').val());
        $('#hide_icd_primer').val($('#icd_primer').val());

        $('#hide_diagnosa_sekunder').val($('#diagnosa_sekunder').val());
        $('#hide_icd_sekunder').val($('#icd_sekunder').val());

        $('#hide_diagnosa_sekunder2').val($('#diagnosa_sekunder2').val());
        $('#hide_icd_sekunder2').val($('#icd_sekunder2').val());

        $('#hide_diagnosa_sekunder3').val($('#diagnosa_sekunder3').val());
        $('#hide_icd_sekunder3').val($('#icd_sekunder3').val());

        $('#hide_diagnosa_sekunder4').val($('#diagnosa_sekunder4').val());
        $('#hide_icd_sekunder4').val($('#icd_sekunder4').val());

        $('#hide_diagnosa_sekunder5').val($('#diagnosa_sekunder5').val());
        $('#hide_icd_sekunder5').val($('#icd_sekunder5').val());

        $('#hide_diagnosa_penyerta1').val($('#diagnosa_penyerta1').val());
        $('#hide_icd_penyerta1').val($('#icd_penyerta1').val());

        $('#hide_diagnosa_penyerta2').val($('#diagnosa_penyerta2').val());
        $('#hide_icd_penyerta2').val($('#icd_penyerta2').val());

        $('#hide_diagnosa_penyerta3').val($('#diagnosa_penyerta3').val());
        $('#hide_icd_penyerta3').val($('#icd_penyerta3').val());

        $('#hide_diagnosa_penyerta4').val($('#diagnosa_penyerta4').val());
        $('#hide_icd_penyerta4').val($('#icd_penyerta4').val());

        $('#hide_diagnosa_penyerta5').val($('#diagnosa_penyerta5').val());
        $('#hide_icd_penyerta5').val($('#icd_penyerta5').val());

        $('#hide_pemeriksaan_lainnya').val($('#pemeriksaan_lainnya').val());
        $('#hide_tindakan_prosedur').val($('#tindakan_prosedur').val());
