...
<head>
    ...
    <title>Surat Pernyataan Status Kepesertaan</title>
    ...
    <div class="container">
        <div class="modal fade" id="modal_petugas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" onsubmit="return cek_form(this)" action="{{ url('e_rekam_medis/detail/save_formulir_surat_pernyataan_rawat_inap') }}">
                        @csrf
                        ...
                        <input type="hidden" id="hide_no_ktp" name="no_ktp">
                        ...
                        <input type="hidden" id="hide_no_ktp_wali" name="no_ktp_wali">
        ...
        <div class="modal fade" id="modal_pasien" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" onsubmit="return konfirmasi_ttd(this)" action="{{ url('e_rekam_medis/detail/save_ttd_formulir_surat_pernyataan_rawat_inap') }}">
                        <div class="modal-body">
                            @csrf
                            <input type="hidden" name="dokumen" value="{{$dokumen->id}}">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h4>SURAT PERNYATAAN STATUS KEPESERTAAN</h4>
            </div>
            <div class="col-md-12 mt-2">
                    ...
                    <table style="border-collapse: collapse; width:100%" class="mb-3">
                        ...
                        <tr class="align-top">
                            ...
                            <td style="width: 3%;"> : </td>
                            <td style="width: 85%;">
                                <input type="text" id="no_ktp_wali" style="border: hidden; border-bottom: 1px dotted; width: 100%" class="mb-2" value="{{ $data ? $data->no_ktp_wali : '' }}"> 
                            </td>
                        </tr>     
                    </table>

                    <p>
                        <input type="radio" value="keluarga" name="radio_hubungan" {{ $data ? ($data->hubungan == 'keluarga' ? 'checked' : '') : '' }}> Keluarga/
                        <input type="radio" value="anak" name="radio_hubungan" {{ $data ? ($data->hubungan == 'anak' ? 'checked' : '') : '' }}> Anak/
                        <input type="radio" value="bapak" name="radio_hubungan" {{ $data ? ($data->hubungan == 'bapak' ? 'checked' : '') : '' }}> Bapak/
                        <input type="radio" value="ibu" name="radio_hubungan" {{ $data ? ($data->hubungan == 'ibu' ? 'checked' : '') : '' }}> Ibu/
                        <input type="radio" value="suami" name="radio_hubungan" {{ $data ? ($data->hubungan == 'suami' ? 'checked' : '') : '' }}> Suami/
                        <input type="radio" value="istri" name="radio_hubungan" {{ $data ? ($data->hubungan == 'istri' ? 'checked' : '') : '' }}> Istri/
                        <input type="radio" value="lain_lain" name="radio_hubungan" {{ $data ? ($data->hubungan == 'lain_lain' ? 'checked' : '') : '' }}> (lain-lain sebutkan 
                        <input type="text" {{ $data ? ($data->hubungan == 'lain_lain' ? '' : 'readonly') : 'readonly' }} id="ket_lain_lain" style="border: hidden; border-bottom: 1px dotted;" class="mb-2" value="{{ $data ? $data->ket_lain_lain : '' }}"> ) dari pasien :
                    </p>
                    ...
                    <table style="border-collapse: collapse; width:100%" class="mb-3">
                        <tr class="align-top">
                            ...
                            <td style="width: 3%;"> : </td>
                            <td style="width: 85%;">
                                <input type="text" id="nama" style="border: hidden; border-bottom: 1px dotted; width: 100%" class="mb-2" value="{{ $data ? $data->nama : $pasien->nama }}">
                            </td>
                        </tr>
                        ...
                        <tr class="align-top">
                            ...
                            <td style="width: 3%;"> : </td>
                            <td style="width: 85%;">
                                <input type="text" id="umur" style="border: hidden; border-bottom: 1px dotted; width: 100%" class="mb-2" value="{{ $data ? $data->umur : $layanan->umur }}"> 
                            </td>
                        </tr>    
                        <tr class="align-top">
                            <td style="width: 12%;">Alamat </td>
                            <td style="width: 3%;"> : </td>
                            <td style="width: 85%;">
                                <input type="text" id="alamat" style="border: hidden; border-bottom: 1px dotted; width: 100%" class="mb-2" value="{{ $data ? $data->alamat : $layanan->alamat_pasien }}"> 
                            </td>
                        </tr>    
                        <tr class="align-top">
                            <td style="width: 12%;">No. KTP</td>
                            <td style="width: 3%;"> : </td>
                            <td style="width: 85%;">
                                <input type="text" id="no_ktp" style="border: hidden; border-bottom: 1px dotted; width: 100%" class="mb-2" value="{{ $data ? $data->no_ktp : $pasien->ktp }}"> 
                            </td>
                        </tr>    
                    </table>
    
                    <p class="mt-3">
                        Akan menyerahkan kartu asuransi <span style="font-weight: bold"> BPJS KESEHATAN/NPJS KETENAGAKERJAAN/JAMPERSAL/JAMKESDA </span> dalam kurun waktu 3x24 jam. Apabila dalam kurun waktu tersebut pasien tidak menyerahkan kartu/kartu tidak aktif ketika diserahkan, maka pasien tersebut dinyatakan sebagai <span style="font-weight: bold">PASIEN UMUM</span>
                    </p>
    
                    <p class="mt-5 text-right mb-5">
                        Cibarusah, <input type="text" class="tanggal_dmy" id="tgl_dokumen" style="border:hidden; border-bottom: 1px dotted;" value="{{ $data ? date('d-m-Y', strtotime($data->tgl_dokumen)) : '' }}">
                    </p>
    
                    <div class="row justify-content-center mb-5">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 33%; text-align: center" onclick="open_modal_petugas()">
                                    Petugas Pendaftaran
                                ...
                                <td style="width: 33%; text-align: center" onclick="open_modal_pasien('saksi')">
                                    Saksi
                                    @if (!is_null($data))
                                ...
                                <td style="width: 33%; text-align: center" onclick="open_modal_pasien('petugas')">
                                    Yang membuat pernyataan
                                    @if (!is_null($data))
                                        @if(is_null($data->nama_petugas) || $data->nama_petugas == "")
                                            <br>
                                            <br>
                                            <br>
                                            <br>
                                        ...
                                        @else
                                            <br>
                                            @if(!is_null($data->ttd_petugas) || $data->ttd_petugas != "")
                                                <img src="{{ asset('signature_patient/'.$data->ttd_petugas) }}"
                                                        style="height: 4cm; width: 5cm;" alt="">
                                            @else
                                                <img src="{{ env('SMIS_UPLOAD_URL').'/' }}" style="height: 4cm; width: 5cm;" alt="">
                                            @endif
                                            <br>({{$data->nama_petugas}})
                                        @endif
                                    @else
                                        <br>
                                        <br>
...
<script>
    ...
    function cek_form() {
        ...
        $('#hide_no_ktp_wali').val($('#no_ktp_wali').val());
