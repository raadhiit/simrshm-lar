...
class CreateSmisDocTindakanAnestesiSpinalEpiduralTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smis_doc_tindakan_anestesi_spinal_epidural', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('smis_doc_tindakan_anestesi_spinal_epidural');
    }
}
