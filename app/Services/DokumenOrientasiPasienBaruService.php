...
use App\Models\Smis_Doc_Dokumen_Orientasi_Pasien_Baru;
...
class DokumenOrientasiPasienBaruService
{
    function create($data)
    {
        $tes = Smis_Doc_Dokumen_Orientasi_Pasien_Baru::updateOrCreate([
            ...
            'lima' => $data->lima,
            'enam' => $data->enam,
            'tujuh_satu' => $data->tujuh_satu,
            'tujuh_dua' => $data->tujuh_dua,
            'tujuh_tiga' => $data->tujuh_tiga,
    ...
    function data($req)
    {
        $data['dokumen'] = DokumenKunjungan::with('dokumen_orientasi_pasien_baru')
        ...
        $layanan = SMIS_LayananPasien::with(['diagnosa', 'pesanan_lab', 'pesanan_radiologi'])
            ...
            ->select('smis_rg_patient.telpon', 'smis_rg_patient.nama', 'smis_rg_patient.tgl_lahir', 'smis_rg_patient.kelamin',
                ...
                'smis_rg_layananpasien.nama_pasien', 'smis_rg_layananpasien.last_ruangan', 'smis_rg_layananpasien.tanggal')
