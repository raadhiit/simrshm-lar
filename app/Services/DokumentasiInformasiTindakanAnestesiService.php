...
use App\Models\Smis_Doc_Informasi_Tindakan_Anestesi_Sedasi;
...
class DokumentasiInformasiTindakanAnestesiService
{
    function data($req)
    {
        $data['dokumen'] = DokumenKunjungan::with('informasi_tindakan_anestesi_sedasi')
    ...
    function create($req)
    {
        $itas = Smis_Doc_Informasi_Tindakan_Anestesi_Sedasi::updateOrCreate([
    ...
    function save_signature($data)
    {
        try {
            ...
            Smis_Doc_Informasi_Tindakan_Anestesi_Sedasi::where('id_dokumen', $data->dokumen)->update([
