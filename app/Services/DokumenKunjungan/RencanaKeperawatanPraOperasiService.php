...
class RencanaKeperawatanPraOperasiService
{
    function data($req)
    {
        ...
        return [
            ...
            'layanan' => $layanan,
            'pasien' => $pasien,
            'data' => DB::table('smis_doc_rencana_keperawatan_pra_operasi')->where('id_dokumen', $req->dokumen)->first()
        ];
    }

    function store($req)
    {
        DB::table('smis_doc_rencana_keperawatan_pra_operasi')->updateOrInsert([
        ...
        return DB::table('smis_doc_rencana_keperawatan_pra_operasi')->where('id_dokumen', $req->dokumen)->first();
    }
}
