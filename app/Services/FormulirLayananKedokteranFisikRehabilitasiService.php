...
class FormulirLayananKedokteranFisikRehabilitasiService
{
    function create($data)
    {
        $tes = FormulirLayananKedokteranFisikRehabilitasi::updateOrCreate([
            ...
            'keputusan_pukul' => $data->keputusan_pukul,
            'reuunp' => $data->reuunp,
