...
class FormulirTriageTerintegrasiService
{
    function create($data)
    {
        $tes = Smis_Doc_Formulir_Triage_Terintegrasi::updateOrCreate([
            'id_dokumen' => $data->dokumen,
        ], [
            'cara_datang' => $data->cara_datang,
            'no_ambulan' => $data->no_ambulan,
            ...
            'doa' => $data->doa,
            'jam_doa' => $data->jam_doa,
            'keluhan_utama' => $data->keluhan_utama,
            'trauma' => $data->trauma,
            'riwayat_penyakit' => $data->riwayat_penyakit,
            'obstetri' => $data->obstetri,
            'imunisasi' => $data->imunisasi,
            'riwayat_alergi' => $data->riwayat_alergi,
            'jalan_nafas' => $data->jalan_nafas,
            'pernafasan' => $data->pernafasan,
            'sirkulasi' => $data->sirkulasi,
            'kesadaran' => $data->kesadaran,
            'checkbox_diagnosa' => $data->checkbox_diagnosa,
            'checkbox_emergent' => $data->checkbox_emergent,
            'checkbox_urgent' => $data->checkbox_urgent,
            'checkbox_not_urgent' => $data->checkbox_not_urgent,
            'checkbox_false_emergency' => $data->checkbox_false_emergency,
        ]);

        Smis_Mr_Tanda_Vital::updateOrCreate([
            'noreg_pasien' => $data->noreg
        ], [
            'keadaan_umum' => $data->keadaan_umum ?? $data->keadaan_umum,
            'tensi' => $data->tensi ?? $data->tensi,
