...
class DataIndukStatusTenagaExport implements FromView, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('data_induk.status_tenaga_excel', [
            'data' => $dataIndukService->getDownloadStatusTenaga($this->request),
        ]);
    }
